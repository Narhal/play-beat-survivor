...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function Mc(){return new Ct({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ml(),fragmentShader:`
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function Sc(){return new Ct({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ml(),fragmentShader:`
	...
	`}function Pg(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===xo||l===Mo,u=l===ls||l===cs;if(c||u){let h=e.get(o);const f=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new vc(i)),h=c?t.fromEquirectangular(o,h):t.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),h.texture;if(h!==void 0)return h.texture;{const d=o.image;return c&&d&&d.height>0||u&&d&&s(d)?(t===null&&(t=new vc(i)),h=c?t.fromEquirectangular(o):t.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),o.addEventListener("dispose",r),h.texture):null}}}return o}function s(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function r(o){const l=o.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function Lg(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&Bu("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function Dg(i,e,t,n){const s={},r=new WeakMap;function a(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const g in f.attributes)e.remove(f.attributes[g]);for(const g in f.morphAttributes){const _=f.morphAttributes[g];for(let p=0,m=_.length;p<m;p++)e.remove(_[p])}f.removeEventListener("dispose",a),delete s[f.id];const d=r.get(f);d&&(e.remove(d),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(h,f){return s[f.id]===!0||(f.addEventListener("dispose",a),s[f.id]=!0,t.memory.geometries++),f}function l(h){const f=h.attributes;for(const g in f)e.update(f[g],i.ARRAY_BUFFER);const d=h.morphAttributes;for(const g in d){const _=d[g];for(let p=0,m=_.length;p<m;p++)e.update(_[p],i.ARRAY_BUFFER)}}function c(h){const f=[],d=h.index,g=h.attributes.position;let _=0;if(d!==null){const y=d.array;_=d.version;for(let x=0,E=y.length;x<E;x+=3){const F=y[x+0],C=y[x+1],w=y[x+2];f.push(F,C,C,w,w,F)}}else if(g!==void 0){const y=g.array;_=g.version;for(let x=0,E=y.length/3-1;x<E;x+=3){const F=x+0,C=x+1,w=x+2;f.push(F,C,C,w,w,F)}}else return;const p=new(Ou(f)?Xu:Wu)(f,1);p.version=_;const m=r.get(h);m&&e.remove(m),r.set(h,p)}function u(h){const f=r.get(h);if(f){const d=h.index;d!==null&&f.version<d.version&&c(h)}else c(h);return r.get(h)}return{get:o,update:l,getWireframeAttribute:u}}function Ug(i,e,t){let n;function s(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function l(f,d){i.drawElements(n,d,r,f*a),t.update(d,n,1)}function c(f,d,g){g!==0&&(i.drawElementsInstanced(n,d,r,f*a,g),t.update(d,n,g))}function u(f,d,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,d,0,r,f,0,g);let p=0;for(let m=0;m<g;m++)p+=d[m];t.update(p,n,1)}function h(f,d,g,_){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let m=0;m<f.length;m++)c(f[m]/a,d[m],_[m]);else{p.multiDrawElementsInstancedWEBGL(n,d,0,r,f,0,_,0,g);let m=0;for(let y=0;y<g;y++)m+=d[y];for(let y=0;y<_.length;y++)t.update(m,n,_[y])}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function Ig(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Ng(i,e,t){const n=new WeakMap,s=new Tt;function r(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0;let f=n.get(o);if(f===void 0||f.count!==h){let S=function(){O.dispose(),n.delete(o),o.removeEventListener("dispose",S)};var d=S;f!==void 0&&f.texture.dispose();const g=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],y=o.morphAttributes.normal||[],x=o.morphAttributes.color||[];let E=0;g===!0&&(E=1),_===!0&&(E=2),p===!0&&(E=3);let F=o.attributes.position.count*E,C=1;F>e.maxTextureSize&&(C=Math.ceil(F/e.maxTextureSize),F=e.maxTextureSize);const w=new Float32Array(F*C*4*h),O=new ku(w,F,C,h);O.type=An,O.needsUpdate=!0;const T=E*4;for(let R=0;R<h;R++){const H=m[R],z=y[R],$=x[R],Y=F*C*4*R;for(let G=0;G<H.count;G++){const K=G*T;g===!0&&(s.fromBufferAttribute(H,G),w[Y+K+0]=s.x,w[Y+K+1]=s.y,w[Y+K+2]=s.z,w[Y+K+3]=0),_===!0&&(s.fromBufferAttribute(z,G),w[Y+K+4]=s.x,w[Y+K+5]=s.y,w[Y+K+6]=s.z,w[Y+K+7]=0),p===!0&&(s.fromBufferAttribute($,G),w[Y+K+8]=s.x,w[Y+K+9]=s.y,w[Y+K+10]=s.z,w[Y+K+11]=$.itemSize===4?s.w:1)}}f={count:h,texture:O,size:new X(F,C)},n.set(o,f),o.addEventListener("dispose",S)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let g=0;for(let p=0;p<c.length;p++)g+=c[p];const _=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",_),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",f.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function Fg(i,e,t,n){let s=new WeakMap;function r(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(s.get(h)!==c&&(e.update(h),s.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;s.get(f)!==c&&(f.update(),s.set(f,c))}return h}function a(){s=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}class Ju extends Lt{constructor(e,t,n,s,r,a,o,l,c,u=es){if(u!==es&&u!==hs)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===es&&(n=Si),n===void 0&&u===hs&&(n=us),super(null,s,r,a,o,l,u,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Kt,this.minFilter=l!==void 0?l:Kt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const ju=new Lt,yc=new Ju(1,1),Qu=new ku,eh=new Ed,th=new $u,Ec=[],Tc=[],bc=new Float32Array(16),Ac=new Float32Array(9),wc=new Float32Array(4);function xs(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=Ec[s];if(r===void 0&&(r=new Float32Array(s),Ec[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function St(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function yt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function _a(i,e){let t=Tc[e];t===void 0&&(t=new Int32Array(e),Tc[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Og(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Bg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2fv(this.addr,e),yt(t,e)}}function zg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(St(t,e))return;i.uniform3fv(this.addr,e),yt(t,e)}}function kg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4fv(this.addr,e),yt(t,e)}}function Vg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),yt(t,e)}else{if(St(t,n))return;wc.set(n),i.uniformMatrix2fv(this.addr,!1,wc),yt(t,n)}}function Hg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),yt(t,e)}else{if(St(t,n))return;Ac.set(n),i.uniformMatrix3fv(this.addr,!1,Ac),yt(t,n)}}function Gg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),yt(t,e)}else{if(St(t,n))return;bc.set(n),i.uniformMatrix4fv(this.addr,!1,bc),yt(t,n)}}function Wg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Xg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2iv(this.addr,e),yt(t,e)}}function qg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;i.uniform3iv(this.addr,e),yt(t,e)}}function Yg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4iv(this.addr,e),yt(t,e)}}function $g(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Kg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2uiv(this.addr,e),yt(t,e)}}function Zg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;i.uniform3uiv(this.addr,e),yt(t,e)}}function Jg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4uiv(this.addr,e),yt(t,e)}}function jg(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(yc.compareFunction=Fu,r=yc):r=ju,t.setTexture2D(e||r,s)}function Qg(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||eh,s)}function e0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||th,s)}function t0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Qu,s)}function n0(i){switch(i){case 5126:return Og;case 35664:return Bg;case 35665:return zg;case 35666:return kg;case 35674:return Vg;case 35675:return Hg;case 35676:return Gg;case 5124:case 35670:return Wg;case 35667:case 35671:return Xg;case 35668:case 35672:return qg;case 35669:case 35673:return Yg;case 5125:return $g;case 36294:return Kg;case 36295:return Zg;case 36296:return Jg;case 35678:case 36198:case 36298:case 36306:case 35682:return jg;case 35679:case 36299:case 36307:return Qg;case 35680:case 36300:case 36308:case 36293:return e0;case 36289:case 36303:case 36311:case 36292:return t0}}function i0(i,e){i.uniform1fv(this.addr,e)}function s0(i,e){const t=xs(e,this.size,2);i.uniform2fv(this.addr,t)}function r0(i,e){const t=xs(e,this.size,3);i.uniform3fv(this.addr,t)}function a0(i,e){const t=xs(e,this.size,4);i.uniform4fv(this.addr,t)}function o0(i,e){const t=xs(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function l0(i,e){const t=xs(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function c0(i,e){const t=xs(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function u0(i,e){i.uniform1iv(this.addr,e)}function h0(i,e){i.uniform2iv(this.addr,e)}function f0(i,e){i.uniform3iv(this.addr,e)}function d0(i,e){i.uniform4iv(this.addr,e)}function p0(i,e){i.uniform1uiv(this.addr,e)}function m0(i,e){i.uniform2uiv(this.addr,e)}function g0(i,e){i.uniform3uiv(this.addr,e)}function _0(i,e){i.uniform4uiv(this.addr,e)}function v0(i,e,t){const n=this.cache,s=e.length,r=_a(t,s);St(n,r)||(i.uniform1iv(this.addr,r),yt(n,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||ju,r[a])}function x0(i,e,t){const n=this.cache,s=e.length,r=_a(t,s);St(n,r)||(i.uniform1iv(this.addr,r),yt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||eh,r[a])}function M0(i,e,t){const n=this.cache,s=e.length,r=_a(t,s);St(n,r)||(i.uniform1iv(this.addr,r),yt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||th,r[a])}function S0(i,e,t){const n=this.cache,s=e.length,r=_a(t,s);St(n,r)||(i.uniform1iv(this.addr,r),yt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Qu,r[a])}function y0(i){switch(i){case 5126:return i0;case 35664:return s0;case 35665:return r0;case 35666:return a0;case 35674:return o0;case 35675:return l0;case 35676:return c0;case 5124:case 35670:return u0;case 35667:case 35671:return h0;case 35668:case 35672:return f0;case 35669:case 35673:return d0;case 5125:return p0;case 36294:return m0;case 36295:return g0;case 36296:return _0;case 35678:case 36198:case 36298:case 36306:case 35682:return v0;case 35679:case 36299:case 36307:return x0;case 35680:case 36300:case 36308:case 36293:return M0;case 36289:case 36303:case 36311:case 36292:return S0}}class E0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=n0(t.type)}}class T0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=y0(t.type)}}class b0{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const Qa=/(\w+)(\])?(\[|\.)?/g;function Cc(i,e){i.seq.push(e),i.map[e.id]=e}function A0(i,e,t){const n=i.name,s=n.length;for(Qa.lastIndex=0;;){const r=Qa.exec(n),a=Qa.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){Cc(t,c===void 0?new E0(o,i,e):new T0(o,i,e));break}else{let h=t.map[o];h===void 0&&(h=new b0(o),Cc(t,h)),t=h}}}class kr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);A0(r,a,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function Rc(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const w0=37297;let C0=0;function R0(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}function P0(i){const e=Je.getPrimaries(Je.workingColorSpace),t=Je.getPrimaries(i);let n;switch(e===t?n="":e===ta&&t===ea?n="LinearDisplayP3ToLinearSRGB":e===ea&&t===ta&&(n="LinearSRGBToLinearDisplayP3"),i){case ni:case ma:return[n,"LinearTransferOETF"];case Yt:case _l:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Pc(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const a=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+R0(i.getShaderSource(e),a)}else return s}function L0(i,e){const t=P0(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function D0(i,e){let t;switch(e){case xu:t="Linear";break;case Mu:t="Reinhard";break;case Su:t="OptimizedCineon";break;case yu:t="ACESFilmic";break;case Eu:t="AgX";break;case Tu:t="Neutral";break;case Vf:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function U0(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Cs).join(`
`)}function I0(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function N0(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Cs(i){return i!==""}function Lc(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Dc(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const F0=/^[ \t]*#include +<([\w\d./]+)>/gm;function $o(i){return i.replace(F0,B0)}const O0=new Map;function B0(i,e){let t=Ue[e];if(t===void 0){const n=O0.get(e);if(n!==void 0)t=Ue[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return $o(t)}const z0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Uc(i){return i.replace(z0,k0)}function k0(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Ic(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function V0(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===_u?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===df?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===yn&&(e="SHADOWMAP_TYPE_VSM"),e}function H0(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ls:case cs:e="ENVMAP_TYPE_CUBE";break;case pa:e="ENVMAP_TYPE_CUBE_UV";break}return e}function G0(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case cs:e="ENVMAP_MODE_REFRACTION";break}return e}function W0(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case vu:e="ENVMAP_BLENDING_MULTIPLY";break;case zf:e="ENVMAP_BLENDING_MIX";break;case kf:e="ENVMAP_BLENDING_ADD";break}return e}function X0(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function q0(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=V0(t),c=H0(t),u=G0(t),h=W0(t),f=X0(t),d=U0(t),g=I0(r),_=s.createProgram();let p,m,y=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+m);const x=y+p+a,E=y+m+o,F=Rc(s,s.VERTEX_SHADER,x),C=Rc(s,s.FRAGMENT_SHADER,E);s.attachShader(_,F),s.attachShader(_,C),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function w(R){if(i.debug.checkShaderErrors){const H=s.getProgramInfoLog(_).trim(),z=s.getShaderInfoLog(F).trim(),$=s.getShaderInfoLog(C).trim();let Y=!0,G=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(Y=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,F,C);else{const K=Pc(s,F,"vertex"),k=Pc(s,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class Ss{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const Ev=new xl(-1,1,1,-1,0,1);class Tv extends zt{constructor(){super(),this.setAttribute("position",new xt([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new xt([0,2,0,0,2,0],2))}}const bv=new Tv;class bl{constructor(e){this._mesh=new Be(bv,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Ev)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class Av extends Ss{constructor(e,t){super(),this.textureID=t!==void 0?t:"tDiffuse",e instanceof Ct?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Xs.clone(e.uniforms),this.material=new Ct({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this.fsQuad=new bl(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this.fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class Qc extends Ss{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const s=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,a,4294967295),r.buffers.stencil.setClear(o),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}}class wv extends Ss{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class Cv{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new X);this._width=n.width,this._height=n.height,t=new an(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Ln}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Av(fh),this.copyPass.material.blending=Pn,this.clock=new uv}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let s=0,r=this.passes.length;s<r;s++){const a=this.passes[s];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){const o=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}Qc!==void 0&&(a instanceof Qc?n=!0:a instanceof wv&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new X);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(n,s),this.renderTarget2.setSize(n,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,s)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class Rv extends Ss{constructor(e,t,n=null,s=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=s,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new ze}render(e,t,n){const s=e.autoClear;e.autoClear=!1;let r,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=s}}const Pv={uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new ze(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}ps.BlurDirectionX=new X(1,0);ps.BlurDirectionY=new X(0,1);const Lv={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
...
`;class Ov{constructor(e){Q(this,"scene",new b_);Q(this,"camera");Q(this,"renderer");Q(this,"composer");Q(this,"styleIndex",0);Q(this,"layersEnabled",!0);Q(this,"bgUniforms");Q(this,"bgMats");Q(this,"bg");Q(this,"layers",[]);Q(this,"bubbles",[]);Q(this,"tintColor",new ze);Q(this,"tintCool",new ze(.3,.62,.75));Q(this,"tintWarm",new ze(.85,.4,.22));Q(this,"walls");Q(this,"zoomKick",0);Q(this,"driftAngle",Math.random()*Math.PI*2);Q(this,"driftPos",new X);Q(this,"journey",0);Q(this,"heat",0);this.renderer=new T_({canvas:e,antialias:!0,preserveDrawingBuffer:!0}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2));const t=window.innerWidth/window.innerHeight;this.camera=new xl(-ln*t,ln*t,ln,-ln,.1,100),this.camera.position.set(0,0,50),this.bgUniforms={uTime:{value:0},uBass:{value:0},uEnergy:{value:0},uDrift:{value:new X},uJourney:{value:0},uHeat:{value:0}},this.bgMats=[Nv,Fv].map(c=>new Ct({uniforms:this.bgUniforms,vertexShader:eu,fragmentShader:c,depthWrite:!1})),this.bg=new Be(new Fn(1200,1200),this.bgMats[0]),this.bg.position.z=-10,this.scene.add(this.bg);for(const[c,u,h]of[[1,260,-8.5],[.45,420,-9]]){const f=new Ct({uniforms:{uMap:{value:null},uDrift:{value:this.driftPos},uParallax:{value:c},uTile:{value:u},uOpacity:{value:0},uTint:{value:new ze}},vertexShader:eu,fragmentShader:Iv,transparent:!0,blending:Un,depthWrite:!1}),d=new Be(new Fn(1200,1200),f);d.position.z=h,d.visible=!1,this.scene.add(d),this.layers.push({mesh:d,mat:f,hasTex:!1,fade:1,pending:null})}const n=new ti(.72,1,16),s=c=>{const u=new it({color:10475752,transparent:!0,opacity:c?.1:.2}),h=new Be(n,u);h.position.set((Math.random()*2-1)*(rt.hw+10),(Math.random()*2-1)*(rt.hh+8),c?6:-7),h.scale.setScalar(c?2.5+Math.random()*2:.5+Math.random()*1.1),this.scene.add(h),this.bubbles.push({mesh:h,speed:(c?7:4)+Math.random()*3,sway:.6+Math.random()*1.2,phase:Math.random()*Math.PI*2})};for(let c=0;c<18;c++)s(!1);for(let c=0;c<6;c++)s(!0);const r=rt.hw,a=rt.hh,o=[new P(-r,-a,0),new P(r,-a,0),new P(r,-a,0),new P(r,a,0),new P(r,a,0),new P(-r,a,0),new P(-r,a,0),new P(-r,-a,0)],l=new zt().setFromPoints(o);this.walls=new A_(l,new Sl({color:3127512})),this.scene.add(this.walls),this.composer=new Cv(this.renderer),this.composer.addPass(new Rv(this.scene,this.camera)),this.composer.addPass(new ps(new X(window.innerWidth,window.innerHeight),1,.5,.5)),this.composer.addPass(new Dv),this.resize(),window.addEventListener("resize",()=>this.resize())}setStyle(e){this.styleIndex=(e%this.bgMats.length+this.bgMats.length)%this.bgMats.length,this.bg.material=this.bgMats[this.styleIndex]}setLayerTexture(e,t){const n=this.layers[e];n.mat.uniforms.uMap.value=t,n.hasTex=!!t,n.pending=null,n.mesh.visible=n.hasTex&&this.layersEnabled}crossfadeLayer(e,t){const n=this.layers[e];if(!n.hasTex){this.setLayerTexture(e,t),n.fade=0;return}n.pending=t}toggleLayers(){this.layersEnabled=!this.layersEnabled;for(const e of this.layers)e.mesh.visible=e.hasTex&&this.layersEnabled;return this.layersEnabled}resize(){const e=window.innerWidth,t=window.innerHeight,n=e/t;this.camera.left=-ln*n,this.camera.right=ln*n,this.camera.top=ln,this.camera.bottom=-ln,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t),this.composer.setSize(e,t)}kick(e){this.zoomKick=Math.min(1,this.zoomKick+e*.7)}update(e,t,n,s){const{bass:r,energy:a,intensity:o,mid:l,danger:c}=n,u=3+o*17;this.driftAngle+=(l-.45)*.9*e+Math.sin(t*.07)*.06*e,this.driftPos.x+=Math.cos(this.driftAngle)*u*e,this.driftPos.y+=Math.sin(this.driftAngle)*u*e,this.journey+=u*e*.012;const h=Math.max(o*.65,c);this.heat+=(h-this.heat)*(1-Math.exp(-e*.45)),this.bgUniforms.uTime.value=t,this.bgUniforms.uBass.value=r,this.bgUniforms.uEnergy.value=a,this.bgUniforms.uDrift.value.copy(this.driftPos),this.bgUniforms.uJourney.value=this.journey,this.bgUniforms.uHeat.value=this.heat,this.tintColor.lerpColors(this.tintCool,this.tintWarm,this.heat);const f=.8+.2*Math.sin(this.journey);for(let x=0;x<this.layers.length;x++){const E=this.layers[x];E.pending?(E.fade-=e/.9,E.fade<=0&&(E.mat.uniforms.uMap.value=E.pending,E.pending=null)):E.fade<1&&(E.fade=Math.min(1,E.fade+e/.9)),E.mat.uniforms.uTint.value.copy(this.tintColor).multiplyScalar(f*(x===0?1:.65)),E.mat.uniforms.uOpacity.value=(x===0?.24+a*.2:.16+a*.12)*Math.max(0,E.fade)}for(const x of this.bubbles)x.mesh.position.y+=x.speed*(.7+o*.7)*e,x.mesh.position.x+=Math.sin(t*x.sway+x.phase)*2.5*e,x.mesh.position.y>rt.hh+10&&(x.mesh.position.y=-150,x.mesh.position.x=(Math.random()*2-1)*(rt.hw+10));this.walls.material.color.setHSL(Math.max(.02,.53-a*.08-this.heat*.4),.9,.28+r*.35);const g=window.innerWidth/window.innerHeight,_=Math.max(0,rt.hw-ln*g),p=Math.max(0,rt.hh-ln),m=fs.clamp(s.x,-_,_),y=fs.clamp(s.y,-p,p);this.camera.position.x+=(m-this.camera.position.x)*Math.min(1,e*5),this.camera.position.y+=(y-this.camera.position.y)*Math.min(1,e*5),this.zoomKick=Math.max(0,this.zoomKick-e*3.5),this.camera.zoom=1+this.zoomKick*.045,this.camera.updateProjectionMatrix(),this.composer.render()}}let oo=null;function Bv(){if(!oo){const i=document.createElement("canvas");i.width=i.height=128;const e=i.getContext("2d"),t=e.createRadialGradient(64,64,0,64,64,64);t.addColorStop(0,"rgba(255,255,255,1)"),t.addColorStop(.25,"rgba(255,255,255,0.95)"),t.addColorStop(.45,"rgba(255,255,255,0.3)"),t.addColorStop(.62,"rgba(255,255,255,0.06)"),t.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=t,e.fillRect(0,0,128,128),oo=new w_(i)}return oo}function xa(i,e){return new it({map:Bv(),color:i,transparent:!0,opacity:e,depthWrite:!1,blending:Un})}const zv=32,kv=5,Vv=7,Hv=4.1,Gv=95,Wv=.16;class Xv{constructor(e){Q(this,"pos",new X(0,0));Q(this,"vel",new X(0,0));Q(this,"lastDir",new X(1,0));Q(this,"hp",3);Q(this,"invuln",0);Q(this,"speedBonus",1);Q(this,"beat",0);Q(this,"dashCd",0);Q(this,"group",new qi);Q(this,"dashTime",0);Q(this,"t",0);Q(this,"mitoMesh",null);Q(this,"membraneMesh",null);Q(this,"glowMesh",null);Q(this,"glowMat",null);const t=new Be(new rn(2.2,32),new it({color:2785178,transparent:!0,opacity:.45})),n=new Be(new ti(2,2.35,32),new it({color:10479871})),s=new Be(new rn(.85,24),new it({color:14220287}));s.position.z=.1,n.position.z=.05,this.group.add(t,n,s),this.group.position.z=2,e.add(this.group)}get dashing(){return this.dashTime>0}tryDash(e){return this.dashCd>0||this.dashTime>0?!1:(this.dashTime=Wv,this.dashCd=e,!0)}reset(){this.pos.set(0,0),this.vel.set(0,0),this.lastDir.set(1,0),this.hp=3,this.invuln=0,this.dashCd=0,this.dashTime=0}update(e,t){this.t+=e,this.dashCd=Math.max(0,this.dashCd-e);const n=Math.min(1,t.length());if(n>.12&&this.lastDir.copy(t).normalize(),this.dashTime>0)this.dashTime-=e,this.vel.copy(this.lastDir).multiplyScalar(Gv);else{const s=new X;n>.12&&s.copy(t).normalize().multiplyScalar(zv*this.speedBonus*n);const r=1-Math.exp(-e*(n>.12?Vv:Hv));this.vel.lerp(s,r)}this.pos.addScaledVector(this.vel,e),Math.abs(this.pos.x)>rt.hw-2&&(this.pos.x=fs.clamp(this.pos.x,-218,rt.hw-2),this.vel.x=0),Math.abs(this.pos.y)>rt.hh-2&&(this.pos.y=fs.clamp(this.pos.y,-138,rt.hh-2),this.vel.y=0),this.invuln=Math.max(0,this.invuln-e),this.group.position.set(this.pos.x,this.pos.y,2),this.group.scale.setScalar((1+Math.sin(this.t*3.2)*.05)*(this.dashing?1.3:1)),this.mitoMesh&&(this.mitoMesh.material.opacity=.32+this.beat*.75,this.mitoMesh.scale.setScalar(2.6*(1+this.beat*.16)),this.mitoMesh.rotation.z+=e*.18),this.membraneMesh&&(this.membraneMesh.rotation.z-=e*.06),this.glowMat&&(this.glowMat.opacity=.4+this.beat*.45),this.group.visible=this.invuln<=0||Math.floor(this.invuln*12)%2===0}setSprites(e,t){this.group.clear();const n=new Fn(2,2);this.glowMat=xa(8255999,.55),this.glowMesh=new Be(n,this.glowMat),this.glowMesh.scale.setScalar(2.3),this.glowMesh.position.z=-.2,this.group.add(this.glowMesh),this.membraneMesh=new Be(n,new it({map:e,transparent:!0,depthWrite:!1})),this.membraneMesh.scale.setScalar(3.1),this.mitoMesh=new Be(n,new it({map:t,transparent:!0,depthWrite:!1,blending:Un,opacity:.5})),this.mitoMesh.scale.setScalar(2.6),this.mitoMesh.position.z=.1,this.group.add(this.membraneMesh,this.mitoMesh)}hit(){return this.invuln>0?!1:(this.hp-=1,this.invuln=1.2,!0)}heal(e=1){this.hp=Math.min(kv,this.hp+e)}}const Ki={globule:{color:16727406,radius:2.6,hp:3,speed:8,xp:3,score:30},meduse:{color:11562239,radius:1.9,hp:2,speed:12,xp:2,score:20},dard:{color:3533055,radius:1.1,hp:1,speed:27,xp:1,score:10},kyste:{color:16752720,radius:2.2,hp:2,speed:3,xp:2,score:25},moucheron:{color:8257514,radius:.8,hp:1,speed:21,xp:1,score:8},colosse:{color:13641816,radius:4.6,hp:14,speed:5,xp:8,score:80}},qv=150,tu=12,Yv=13,$v=6;function nu(i,e,t){const n=[];for(let r=0;r<i;r++){const a=r/i*Math.PI*2,o=1+Math.sin(t+r*2.4)*e+Math.cos(t*1.7+r*3.1)*e*.6;n.push(new X(Math.cos(a)*o,Math.sin(a)*o))}const s=new Ms;return s.moveTo(n[0].x,n[0].y),s.splineThru([...n.slice(1),n[0]]),new bi(s)}function Kv(){const i=new Ms;return i.moveTo(.15,.85),i.quadraticCurveTo(1.15,0,.15,-.85),i.lineTo(-.85,-.65),i.lineTo(-.35,-.32),i.lineTo(-1.05,-.05),i.lineTo(-.35,.22),i.lineTo(-.85,.6),i.closePath(),new bi(i)}function Zv(){const i=new Ms;return i.moveTo(1.5,0),i.lineTo(-.3,.45),i.lineTo(-1.1,0),i.lineTo(-.3,-.45),i.closePath(),new bi(i)}function Jv(){const i=[];for(let t=0;t<16;t++){const n=t/16*Math.PI*2,s=t%2===0?1:.72;i.push(new X(Math.cos(n)*s,Math.sin(n)*s))}const e=new Ms;return e.moveTo(i[0].x,i[0].y),e.splineThru([...i.slice(1),i[0]]),new bi(e)}const jv=new Set(["meduse","dard","moucheron"]),Qv={dard:[.95,.3],moucheron:[.55,.45],meduse:[.52,.48],kyste:[.6,.6],colosse:[.7,.7]},ex=[.6,.6];class tx{constructor(e){Q(this,"list",[]);Q(this,"spritesEnabled",!0);Q(this,"kysteRadiusMul",1);Q(this,"sprites",{});Q(this,"spriteGeo",new Fn(2,2));Q(this,"spriteMats",new Map);Q(this,"scene");Q(this,"geos");Q(this,"mats");Q(this,"pool",[]);Q(this,"haloMats",{});this.scene=e,this.geos={globule:nu(10,.15,3),meduse:Kv(),dard:Zv(),kyste:Jv(),moucheron:new rn(1,3),colosse:nu(12,.2,7)},this.mats=Object.fromEntries(Object.keys(Ki).map(t=>[t,new it({color:Ki[t].color})]))}setSprites(e,t){this.sprites[e]=t}haloFor(e){let t=this.haloMats[e];return t||(t=xa(Ki[e].color,.85),this.haloMats[e]=t),t}matFor(e,t){let n=this.spriteMats.get(e);return n||(n=new it({map:e,transparent:!0,depthWrite:!1,blending:t?Un:vi}),this.spriteMats.set(e,n)),n}spawn(e,t,n,s,r=1){const a=e==="kyste"?this.interiorPoint(t):this.edgePoint(t);this.add(e,a,t,n,s,r)}interiorPoint(e){let t=new X;for(let n=0;n<10&&(t.set((Math.random()*2-1)*(rt.hw-8),(Math.random()*2-1)*(rt.hh-8)),!(t.distanceTo(e)>28));n++);return t}squad(e,t,n,s,r,a=1){const o=this.edgePoint(t);for(let l=0;l<n;l++){const c=o.clone().add(new X((Math.random()-.5)*6,(Math.random()-.5)*6));this.add(e,c,t,s,r,a)}}burstAt(e,t,n,s,r=1){for(let a=0;a<s;a++){const o=t.clone().add(new X((Math.random()-.5)*3,(Math.random()-.5)*3));this.add(e,o,n,.6,1,r,(a-(s-1)/2)*.45)}}emitRadial(e,t,n,s=1){const r=Math.random()*Math.PI*2;for(let a=0;a<n;a++){const o=r+a*Math.PI*2/n,l=t.clone().add(new X(Math.cos(o),Math.sin(o)));this.add(e,t.clone(),l,.6,1,s)}}edgePoint(e){let t=new X;for(let n=0;n<8;n++){const s=Math.floor(Math.random()*4),r=(Math.random()*2-1)*rt.hw,a=(Math.random()*2-1)*rt.hh;if(t=s===0?new X(r,rt.hh-1):s===1?new X(r,-139):s===2?new X(rt.hw-1,a):new X(-219,a),t.distanceTo(e)>35)break}return t}add(e,t,n,s,r,a,o=0){if(this.list.length>=qv)return;const l=Ki[e],c=.8+s*.5;let u;if(e==="kyste"){const y=Math.random()*Math.PI*2;u=new X(Math.cos(y),Math.sin(y))}else e==="colosse"?u=new X((Math.random()*2-1)*rt.hw*.5,(Math.random()*2-1)*rt.hh*.5).sub(t).normalize():(u=new X().subVectors(n,t).normalize(),o!==0&&u.rotateAround(new X,o));const h=this.pool.pop()??new Be,f=this.spritesEnabled?this.sprites[e]:void 0;let d=l.radius*c,g=0;f&&f.textures.length>0?(h.geometry=this.spriteGeo,h.material=this.matFor(f.textures[Math.floor(Math.random()*f.textures.length)],f.additive),d*=f.scale,g=f.rotOffset):(h.geometry=this.geos[e],h.material=this.mats[e]);let _=h.userData.halo;_||(_=new Be(this.spriteGeo,this.haloFor(e)),_.position.z=-.06,h.userData.halo=_,h.add(_)),_.material=this.haloFor(e);const[p,m]=Qv[e]??ex;_.scale.set(p,m,1),h.scale.setScalar(d),h.position.set(t.x,t.y,1),h.visible=!0,this.scene.add(h),this.list.push({kind:e,pos:t.clone(),dir:u,hp:Math.ceil(l.hp*c*(1+(r-1)*.5)),radius:l.radius*c,speed:l.speed*(.9+Math.random()*.2)*(1+(r-1)*.25)*a,phase:Math.random()*Math.PI*2,baseScale:d,spriteRot:g,telegraph:0,deadline:0,mesh:h,orbHitCd:0,tentHitCd:0})}update(e,t,n,s){const r=[],a=[];for(const o of this.list){switch(o.orbHitCd=Math.max(0,o.orbHitCd-e),o.tentHitCd=Math.max(0,o.tentHitCd-e),o.kind){case"globule":{const l=new X().subVectors(n,o.pos).normalize();o.pos.addScaledVector(l,o.speed*e),o.dir.copy(l);break}case"colosse":{o.pos.addScaledVector(o.dir,o.speed*e),o.telegraph+=e,(o.deadline>0?t>=o.deadline:o.telegraph>=tu)&&a.push(o);break}case"meduse":{const l=new X().subVectors(n,o.pos).normalize(),c=new X(-l.y,l.x).multiplyScalar(Math.sin(t*3+o.phase)*.8),u=l.add(c).normalize();o.pos.addScaledVector(u,o.speed*e),o.dir.copy(u);break}case"moucheron":{const l=new X().subVectors(n,o.pos).normalize(),c=new X(-l.y,l.x).multiplyScalar(Math.sin(t*7+o.phase)*1.2),u=l.add(c).normalize();o.pos.addScaledVector(u,o.speed*e),o.dir.copy(u);break}case"dard":{o.pos.addScaledVector(o.dir,o.speed*e);break}case"kyste":{o.pos.distanceTo(n)<12?(o.telegraph+=e,o.telegraph>=.9&&r.push(o)):o.telegraph=Math.max(0,o.telegraph-e*1.5);break}}if(o.mesh.position.set(o.pos.x,o.pos.y,1),jv.has(o.kind))o.mesh.rotation.z=Math.atan2(o.dir.y,o.dir.x)+o.spriteRot,o.mesh.scale.setScalar(o.baseScale);else if(o.kind==="kyste")o.mesh.rotation.z=t*.4+o.phase,o.mesh.scale.setScalar(o.baseScale*(1+o.telegraph*.5*(1+Math.sin(t*22))));else{o.mesh.rotation.z=t*.6+o.phase;const l=o.kind==="colosse"?o.deadline>0?o.deadline-t:tu-o.telegraph:1/0,c=Math.min(1,Math.max(0,(3-l)/3));o.mesh.scale.setScalar(o.baseScale*(1+(.06+c*.2)*Math.sin(t*(2.8+c*14)+o.phase)))}}for(const o of r){const l=this.list.indexOf(o);if(l<0)continue;this.remove(l),s?.onPop?.(o.pos,"kyste");const c=Yv*this.kysteRadiusMul;for(let u=this.list.length-1;u>=0;u--){const h=this.list[u];h.pos.distanceTo(o.pos)<c&&(h.hp-=$v,h.hp<=0&&(s?.onKill?.(h),this.remove(u)))}}for(const o of a){const l=this.list.indexOf(o);l<0||(this.remove(l),s?.onPop?.(o.pos,"colosse"),this.emitRadial("dard",o.pos,6,1.05))}for(let o=this.list.length-1;o>=0;o--){const l=this.list[o];(l.kind==="dard"||l.kind==="moucheron"||l.kind==="colosse")&&(Math.abs(l.pos.x)>rt.hw+8||Math.abs(l.pos.y)>rt.hh+8)&&this.remove(o)}}remove(e){const t=this.list[e];this.scene.remove(t.mesh),t.mesh.visible=!1,this.pool.push(t.mesh),this.list.splice(e,1)}clear(){for(;this.list.length;)this.remove(this.list.length-1)}}const Zi={blaster:{name:"Anticorps",desc:"Tire sur le pathogène le plus proche.",cat:"Arme"},eventail:{name:"Éventail",desc:"Gerbe de projectiles vers l'arrière — couvre ta fuite.",cat:"Arme"},mine:{name:"Mine",desc:"Pond régulièrement une mine qui explose à l'approche des pathogènes.",cat:"Arme"},arc:{name:"Arc voltaïque",desc:"Cône électrique devant toi : tout ce qui y entre grille. Bref aux premiers paliers, puis plus long et plus ample.",cat:"Arme"},orbes:{name:"Orbes",desc:"Satellites en orbite, dégâts de contact.",cat:"Arme"},onde:{name:"Onde de choc",desc:"Anneau périodique qui balaie autour de toi.",cat:"Arme"},tentacule:{name:"Filament",desc:"Un long filament urticant traîne paresseusement derrière toi (réf. méduse). Paliers : longueur, dégâts, jusqu'à 3 filaments.",cat:"Arme"},apoptose:{name:"Apoptose",desc:"L2 : purge tout l'écran une fois chargée — se charge plus vite par palier.",cat:"Arme"},flagelles:{name:"Flagelles",desc:"Vitesse de nage augmentée à chaque palier.",cat:"Atout"},membrane:{name:"Membrane",desc:"Absorbe un coup, puis se recharge — de plus en plus vite par palier.",cat:"Atout"},mitose:{name:"Mitose",desc:"Régulièrement, un pathogène détruit laisse un cœur — plus souvent par palier.",cat:"Passif"},enzymes:{name:"Enzymes",desc:"+15 % de dégâts pour toutes les armes par palier.",cat:"Passif"},phagocytose:{name:"Phagocytose",desc:"Attire les protéines des pathogènes de plus en plus loin.",cat:"Passif"}},nx=5,ui=22,ix=.5,sx=5;function ph(i){return i==="tentacule"?7:nx}class rx{constructor(e){Q(this,"levels",new Map);Q(this,"shieldCharged",!1);Q(this,"nukeCharge",0);Q(this,"metaDamageMul",1);Q(this,"metaMagnet",0);Q(this,"bonusNukes",0);Q(this,"saccadeLevel",0);Q(this,"beatNow",!1);Q(this,"ondeWait",0);Q(this,"shieldTimer",0);Q(this,"scene");Q(this,"cooldowns",new Map);Q(this,"projectiles",[]);Q(this,"waves",[]);Q(this,"orbMeshes",[]);Q(this,"orbAngle",0);Q(this,"tentacleMeshes",[]);Q(this,"filaments",[]);Q(this,"mines",[]);Q(this,"explosions",[]);Q(this,"arcMesh",null);Q(this,"arcTimer",0);Q(this,"arcParams",{len:0,half:0});Q(this,"shieldMesh");Q(this,"time",0);Q(this,"projGeo",new rn(.55,8));Q(this,"projMat",new it({color:16774048}));Q(this,"waveGeo",new ti(.92,1,48));Q(this,"orbGeo",new rn(1.15,12));Q(this,"orbMat",new it({color:9371584}));Q(this,"tentGeo",new rn(1,10));Q(this,"tentMat",new it({color:6746328}));Q(this,"mineGeo",new rn(.8,12));Q(this,"mineMat",new it({color:16761710}));Q(this,"projPool",[]);this.scene=e,this.levels.set("blaster",1),this.shieldMesh=new Be(new ti(3,3.35,32),new it({color:8255999,transparent:!0,opacity:.55})),this.shieldMesh.visible=!1,e.add(this.shieldMesh)}reset(){this.levels.clear(),this.levels.set("blaster",1),this.cooldowns.clear();for(const e of this.projectiles)this.scene.remove(e.mesh);this.projectiles=[];for(const e of this.waves)this.scene.remove(e.mesh);this.waves=[],this.shieldCharged=!1,this.shieldTimer=0,this.nukeCharge=0;for(const e of this.mines)this.scene.remove(e.mesh);this.mines=[];for(const e of this.explosions)this.scene.remove(e.mesh);this.explosions=[],this.arcMesh&&(this.scene.remove(this.arcMesh),this.arcMesh.geometry.dispose(),this.arcMesh=null),this.arcTimer=0,this.syncOrbs(),this.syncTentacle()}get damageMul(){return(1+.15*(this.levels.get("enzymes")??0))*this.metaDamageMul}get speedBonus(){return 1+.06*(this.levels.get("flagelles")??0)}get mitoseThreshold(){const e=this.levels.get("mitose")??0;return e>0?Math.max(10,45-8*(e-1)):0}get magnetRadius(){return 6+4*(this.levels.get("phagocytose")??0)+this.metaMagnet}get dashCooldown(){return 2.4*(1-.09*this.saccadeLevel)}get dashInvuln(){return this.saccadeLevel>=3}get dashDamage(){return this.saccadeLevel>=5?2*this.damageMul:0}fireNuke(){return this.bonusNukes>0?(this.bonusNukes--,!0):(this.levels.get("apoptose")??0)>0&&this.nukeCharge>=1?(this.nukeCharge=0,!0):!1}absorbHit(){if((this.levels.get("membrane")??0)>0&&this.shieldCharged){this.shieldCharged=!1;const e=this.levels.get("membrane")??1;return this.shieldTimer=22*Math.pow(.75,e-1),!0}return!1}drawCards(){const e=[...this.levels.keys()].filter(s=>Zi[s].cat==="Arme").length,t=[];for(const s of Object.keys(Zi)){const r=this.levels.get(s)??0;r>=ph(s)||r===0&&Zi[s].cat==="Arme"&&e>=sx||t.push({kind:s,level:r+1,weight:r>0?3:1})}const n=[];for(;n.length<3&&t.length>0;){const s=t.reduce((l,c)=>l+c.weight,0);let r=Math.random()*s,a=0;for(;a<t.length-1&&(r-=t[a].weight)>0;)a++;const o=t.splice(a,1)[0];n.push({kind:o.kind,level:o.level})}return n}pick(e){this.levels.set(e,(this.levels.get(e)??0)+1),e==="membrane"&&(this.levels.get("membrane")??0)===1&&(this.shieldCharged=!0),e==="orbes"&&this.syncOrbs()}update(e,t,n,s){this.time+=e;const r=this.damageMul;(this.levels.get("membrane")??0)>0&&!this.shieldCharged&&(this.shieldTimer-=e,this.shieldTimer<=0&&(this.shieldCharged=!0));const a=this.levels.get("apoptose")??0;if(a>0&&this.nukeCharge<1){const c=45*Math.pow(.8,a-1);this.nukeCharge=Math.min(1,this.nukeCharge+e/c)}this.shieldMesh.visible=this.shieldCharged,this.shieldMesh.visible&&(this.shieldMesh.position.set(t.pos.x,t.pos.y,1.9),this.shieldMesh.rotation.z=this.time*.8);for(const[c,u]of this.levels){const h=(this.cooldowns.get(c)??0)-e;if(h>0){this.cooldowns.set(c,h);continue}switch(c){case"blaster":{const f=this.nearest(t.pos,n);if(f){const d=new X().subVectors(f.pos,t.pos).normalize();this.fire(t.pos,d,65,(1+Math.floor(u/2))*r),this.cooldowns.set(c,.5/(1+(u-1)*.35))}break}case"eventail":{const f=Math.atan2(t.lastDir.y,t.lastDir.x)+Math.PI,d=3+u,g=Math.PI/5;for(let _=0;_<d;_++){const p=f-g/2+g*_/(d-1);this.fire(t.pos,new X(Math.cos(p),Math.sin(p)),55,1*r)}this.cooldowns.set(c,1.15/(1+(u-1)*.25));break}case"onde":{if(!this.beatNow&&this.ondeWait<.6){this.ondeWait+=e;break}this.ondeWait=0;const f={radius:2,maxRadius:14+u*4,dmg:(2+Math.floor(u/2))*r,hitSet:new Set,mesh:new Be(this.waveGeo,new it({color:3533055,transparent:!0,opacity:.8}))};f.mesh.position.set(t.pos.x,t.pos.y,1.5),this.scene.add(f.mesh),this.waves.push(f),this.cooldowns.set(c,2.4/(1+(u-1)*.2));break}case"mine":{const f=new Be(this.mineGeo,this.mineMat);f.position.set(t.pos.x,t.pos.y,.8),this.scene.add(f),this.mines.push({pos:t.pos.clone(),mesh:f,age:0}),this.cooldowns.set(c,3.5/(1+(u-1)*.22));break}case"arc":{const f=14+u*3,d=.35+u*.06;this.arcParams={len:f,half:d},this.arcTimer=.7+u*.25,this.arcMesh&&(this.scene.remove(this.arcMesh),this.arcMesh.geometry.dispose());const g=new Ms;g.moveTo(0,0);const _=14;for(let p=0;p<=_;p++){const m=-d+2*d*p/_;g.lineTo(Math.cos(m),Math.sin(m))}g.closePath(),this.arcMesh=new Be(new bi(g),new it({color:12514303,transparent:!0,opacity:.35,blending:Un,depthWrite:!1})),this.arcMesh.scale.setScalar(f),this.scene.add(this.arcMesh),this.cooldowns.set(c,6.5);break}}}for(let c=this.mines.length-1;c>=0;c--){const u=this.mines[c];u.age+=e,u.mesh.scale.setScalar(1+.15*Math.sin(u.age*8));let h=u.age>6;if(!h&&u.age>.4){for(const f of n.list)if(f.pos.distanceTo(u.pos)<3.6){h=!0;break}}if(h){const f=this.levels.get("mine")??1,d=8+f*1.5,g=(5+f*2)*r;for(let p=n.list.length-1;p>=0;p--){const m=n.list[p];m.pos.distanceTo(u.pos)<d&&(m.hp-=g,m.hp<=0&&(s({enemy:m}),n.remove(p)))}const _=new Be(this.waveGeo,new it({color:16761710,transparent:!0,opacity:.85}));_.position.set(u.pos.x,u.pos.y,1.5),this.scene.add(_),this.explosions.push({mesh:_,life:.35,max:d}),this.scene.remove(u.mesh),this.mines.splice(c,1)}}for(let c=this.explosions.length-1;c>=0;c--){const u=this.explosions[c];u.life-=e;const h=1-u.life/.35;u.mesh.scale.setScalar(Math.max(.01,u.max*h)),u.mesh.material.opacity=.85*(1-h),u.life<=0&&(this.scene.remove(u.mesh),u.mesh.material.dispose(),this.explosions.splice(c,1))}if(this.arcTimer>0&&this.arcMesh){this.arcTimer-=e;const c=Math.atan2(t.lastDir.y,t.lastDir.x);this.arcMesh.position.set(t.pos.x,t.pos.y,1.45),this.arcMesh.rotation.z=c,this.arcMesh.material.opacity=.2+Math.random()*.28;const{len:u,half:h}=this.arcParams;for(let f=n.list.length-1;f>=0;f--){const d=n.list[f],g=new X().subVectors(d.pos,t.pos);if(g.length()<u+d.radius){let p=Math.atan2(g.y,g.x)-c;for(;p>Math.PI;)p-=Math.PI*2;for(;p<-Math.PI;)p+=Math.PI*2;Math.abs(p)<h&&(d.hp=0,s({enemy:d}),n.remove(f))}}this.arcTimer<=0&&(this.scene.remove(this.arcMesh),this.arcMesh.geometry.dispose(),this.arcMesh=null)}for(let c=this.projectiles.length-1;c>=0;c--){const u=this.projectiles[c];u.pos.addScaledVector(u.vel,e),u.life-=e,u.mesh.position.set(u.pos.x,u.pos.y,1.5);let h=u.life<=0;if(!h)for(let f=n.list.length-1;f>=0;f--){const d=n.list[f];if(u.pos.distanceTo(d.pos)<d.radius+.6){d.hp-=u.dmg,h=!0,d.hp<=0&&(s({enemy:d}),n.remove(f));break}}h&&(this.scene.remove(u.mesh),this.projPool.push(u.mesh),this.projectiles.splice(c,1))}for(let c=this.waves.length-1;c>=0;c--){const u=this.waves[c];u.radius+=e*34,u.mesh.scale.setScalar(u.radius);const h=u.mesh.material;h.opacity=.8*(1-u.radius/u.maxRadius);const f=new X(u.mesh.position.x,u.mesh.position.y);for(let d=n.list.length-1;d>=0;d--){const g=n.list[d];if(u.hitSet.has(g))continue;const _=f.distanceTo(g.pos);Math.abs(_-u.radius)<g.radius+1.2&&(u.hitSet.add(g),g.hp-=u.dmg,g.hp<=0&&(s({enemy:g}),n.remove(d)))}u.radius>=u.maxRadius&&(this.scene.remove(u.mesh),u.mesh.material.dispose(),this.waves.splice(c,1))}const o=this.levels.get("orbes")??0;if(o>0){this.orbAngle+=e*2.6;const c=8.5;for(let u=0;u<this.orbMeshes.length;u++){const h=this.orbAngle+u*Math.PI*2/this.orbMeshes.length,f=t.pos.x+Math.cos(h)*c,d=t.pos.y+Math.sin(h)*c;this.orbMeshes[u].position.set(f,d,1.5);const g=new X(f,d);for(let _=n.list.length-1;_>=0;_--){const p=n.list[_];p.orbHitCd>0||g.distanceTo(p.pos)<p.radius+1.15&&(p.orbHitCd=.5,p.hp-=(1+Math.floor(o/2))*r,p.hp<=0&&(s({enemy:p}),n.remove(_)))}}}const l=this.levels.get("tentacule")??0;if(l>0){const c=l>=5?3:l>=3?2:1,h=(13+l*2)/ui,f=(1.2+l*.25)*r;if(this.filaments.length!==c){for(const _ of this.tentacleMeshes)this.scene.remove(_);this.tentacleMeshes=[],this.filaments=[];for(let _=0;_<c;_++){const p=[];for(let m=0;m<ui;m++)p.push(t.pos.clone());this.filaments.push(p);for(let m=0;m<ui;m++){const y=new Be(this.tentGeo,this.tentMat);this.scene.add(y),this.tentacleMeshes.push(y)}}}const d=t.lastDir,g=new X(-d.y,d.x);for(let _=0;_<c;_++){const p=this.filaments[_],m=t.pos.clone().addScaledVector(d,-1.4).addScaledVector(g,(_-(c-1)/2)*1.8);p[0].lerp(m,1-Math.exp(-e*14));for(let y=1;y<ui;y++){const x=p[y].clone().sub(p[y-1]),E=Math.max(1e-4,x.length()),F=p[y-1].clone().addScaledVector(x.multiplyScalar(1/E),h);p[y].lerp(F,1-Math.exp(-e*9))}for(let y=0;y<ui;y++){const x=this.tentacleMeshes[_*ui+y],E=.24*(1-y/ui*.5);x.position.set(p[y].x,p[y].y,1.4),x.scale.setScalar(E);for(let F=n.list.length-1;F>=0;F--){const C=n.list[F];C.tentHitCd>0||p[y].distanceTo(C.pos)<C.radius+ix&&(C.tentHitCd=.3,C.hp-=f,C.hp<=0&&(s({enemy:C}),n.remove(F)))}}}}}fire(e,t,n,s){const r=this.projPool.pop()??new Be(this.projGeo,this.projMat);r.position.set(e.x,e.y,1.5),this.scene.add(r),this.projectiles.push({pos:e.clone(),vel:t.clone().multiplyScalar(n),life:2.2,dmg:s,mesh:r})}nearest(e,t){let n=null,s=1/0;for(const r of t.list){const a=e.distanceToSquared(r.pos);a<s&&(s=a,n=r)}return n}syncOrbs(){for(const t of this.orbMeshes)this.scene.remove(t);this.orbMeshes=[];const e=this.levels.get("orbes")??0;if(e>0){const t=1+e;for(let n=0;n<t;n++){const s=new Be(this.orbGeo,this.orbMat);this.scene.add(s),this.orbMeshes.push(s)}}}syncTentacle(){for(const e of this.tentacleMeshes)this.scene.remove(e);this.tentacleMeshes=[],this.filaments=[]}describe(){const e=[];this.bonusNukes>0&&e.push(`Réserve d'Apoptose ×${this.bonusNukes} (L2)`);for(const[t,n]of this.levels)if(t==="apoptose"){const s=this.nukeCharge>=1?"PRÊTE — L2 !":`${Math.floor(this.nukeCharge*100)} %`;e.push(`Apoptose · niv ${n} · ${s}`)}else e.push(`${Zi[t].name} · niv ${n}`);return e}}const Zn=44100;function lo(i,e){return Math.round(i*e)/e}async function mh(){const e=new OfflineAudioContext(2,Math.round(12.8*Zn),Zn),t=e.createGain();t.gain.value=.9,t.connect(e.destination);const n=e.createBiquadFilter();n.type="lowpass",n.frequency.value=520,n.Q.value=1.2;const s=e.createGain();s.gain.value=.055,n.connect(s),s.connect(t);const r=e.createOscillator();r.frequency.value=lo(.156,12.8);const a=e.createGain();a.gain.value=280,r.connect(a),a.connect(n.frequency),r.start(0);for(const d of[110,130.8,164.8,196,246.9])for(const g of[0,1/12.8]){const _=e.createOscillator();_.type="sawtooth",_.frequency.value=lo(d,12.8)+g,_.connect(n),_.start(0)}const o=e.createOscillator();o.type="sine",o.frequency.value=lo(55,12.8);const l=e.createGain();l.gain.value=.11,o.connect(l),l.connect(t),o.start(0);const c=[110,130.8,146.8,164.8,196,220],u=[0,-1,3,-1,5,-1,2,-1,0,-1,4,3,-1,2,-1,1],h=.2;for(let d=0;d<4;d++)for(let g=0;g<u.length;g++){const _=u[g];if(_<0)continue;const p=d*u.length*h+g*h;if(p>12.8-.3)continue;const m=e.createOscillator();m.type="sawtooth",m.frequency.value=c[_]*2;const y=e.createBiquadFilter();y.type="lowpass",y.Q.value=11,y.frequency.setValueAtTime(240,p),y.frequency.exponentialRampToValueAtTime(1500,p+.05),y.frequency.exponentialRampToValueAtTime(280,p+.16);const x=e.createGain();x.gain.setValueAtTime(.05,p),x.gain.exponentialRampToValueAtTime(.001,p+.18),m.connect(y),y.connect(x),x.connect(t),m.start(p),m.stop(p+.2)}const f=gh(42);for(let d=0;d<12;d++){const g=.5+f()*9.600000000000001,_=1400+f()*2800;for(let p=0;p<3;p++){const m=g+p*.34,y=e.createOscillator();y.type="sine",y.frequency.value=_;const x=e.createGain(),E=.035*Math.pow(.45,p);x.gain.setValueAtTime(E,m),x.gain.exponentialRampToValueAtTime(5e-4,m+.09),y.connect(x),x.connect(t),y.start(m),y.stop(m+.1)}}return e.startRendering()}async function ax(){const e=new OfflineAudioContext(2,Math.round(3.5*Zn),Zn),t=e.createGain();t.gain.value=.9,t.connect(e.destination);const n=e.createBuffer(1,Zn*3.5,Zn),s=n.getChannelData(0);for(let c=0;c<s.length;c++)s[c]=Math.random()*2-1;const r=e.createBufferSource();r.buffer=n;const a=e.createBiquadFilter();a.type="lowpass",a.frequency.value=320;const o=e.createGain();o.gain.setValueAtTime(1e-4,0),o.gain.linearRampToValueAtTime(.05,.8),o.gain.linearRampToValueAtTime(1e-4,3.5),r.connect(a),a.connect(o),o.connect(t),r.start(0);const l=gh(7);for(let c=0;c<22;c++){const u=.15+l()*2.9,h=260+l()*620,f=.05+l()*.05,d=e.createOscillator();d.type="sine",d.frequency.setValueAtTime(h,u),d.frequency.exponentialRampToValueAtTime(h*1.7,u+f);const g=e.createGain();g.gain.setValueAtTime(1e-4,u),g.gain.exponentialRampToValueAtTime(.14,u+.012),g.gain.exponentialRampToValueAtTime(5e-4,u+f+.03),d.connect(g),g.connect(t),d.start(u),d.stop(u+f+.05)}return e.startRendering()}async function ox(){const e=new OfflineAudioContext(2,Math.round(1.4*Zn),Zn),t=e.createGain();t.gain.value=.9,t.connect(e.destination);for(let n=0;n<3;n++){const s=n*.28,r=.5*Math.pow(.38,n),a=e.createOscillator();a.type="sine",a.frequency.setValueAtTime(1350,s),a.frequency.exponentialRampToValueAtTime(340,s+.09);const o=e.createGain();o.gain.setValueAtTime(r,s),o.gain.exponentialRampToValueAtTime(5e-4,s+.14),a.connect(o),o.connect(t),a.start(s),a.stop(s+.16)}return e.startRendering()}function lx(){try{const i=new SpeechSynthesisUtterance("Beat Survivor");i.pitch=.15,i.rate=.72,i.volume=.9;const e=speechSynthesis.getVoices(),t=e.find(n=>n.lang.startsWith("fr"))??e[0];t&&(i.voice=t),speechSynthesis.speak(i)}catch{}}function gh(i){let e=i;return()=>{e|=0,e=e+1831565813|0;let t=Math.imul(e^e>>>15,1|e);return t=t+Math.imul(t^t>>>7,61|t)^t,((t^t>>>14)>>>0)/4294967296}}const cx=[{id:"vacuole",name:"Vacuole de réserve",desc:"+1 PV au départ de chaque run.",max:2,baseCost:150,growth:2.5},{id:"cils",name:"Cils moteurs",desc:"+4 % de vitesse de nage par palier.",max:5,baseCost:60,growth:1.8},{id:"concentres",name:"Enzymes concentrées",desc:"+8 % de dégâts par palier, toutes armes.",max:5,baseCost:80,growth:1.8},{id:"phago",name:"Cils phagocytaires",desc:"Aimant à protéines élargi dès le départ.",max:3,baseCost:70,growth:1.8},{id:"reserve",name:"Réserve d'Apoptose",desc:"+1 charge d'Apoptose prête dès le départ (L2), par palier.",max:3,baseCost:120,growth:2},{id:"virulence",name:"Virulence",desc:"+18 % de rayon d'explosion des kystes par palier — ils nettoient plus large.",max:5,baseCost:70,growth:1.7},{id:"saccade",name:"Saccade",desc:"Dash (R1) plus prompt par palier ; palier 3 : invulnérable pendant ; palier 5 : il déchire sur son passage.",max:5,baseCost:100,growth:1.8},{id:"reroll",name:"Plasticité",desc:"+1 relance des choix d'évolution par run, par palier (R1 sur l'écran de choix).",max:5,baseCost:90,growth:1.8}],ms=[{id:"reguliere",name:"La Régulière",desc:"La cellule de base — équilibrée, fiable.",unlockFile:null},{id:"phage",name:"Le Phage",desc:"1 PV. Dégâts ×1,5 et +10 % de vitesse — tout dans l'attaque.",unlockFile:"Anxious pathogene.mp3",unlockWith:"reguliere"},{id:"tardigrade",name:"Le Tardigrade",desc:"Ne meurt jamais. Chaque coup encaissé disperse ta jauge et te coûte de l'XP.",unlockFile:"Beyond abyss.mp3",unlockWith:"phage"},{id:"amibe",name:"L'Amibe",desc:"Aimant énorme et +50 % d'XP collectée, mais lente et fragile.",unlockFile:"Dreamy Dive.mp3",unlockWith:"reguliere"},{id:"symbiote",name:"Le Symbiote",desc:"Les évolutions se choisissent toutes seules : la run ne s'interrompt jamais.",unlockFile:"Never see the light again.mp3",unlockWith:"reguliere"}];function ux(i,e){return Math.round(i.baseCost*Math.pow(i.growth,e))}const _h="bs-meta";function hx(){try{const i=localStorage.getItem(_h);if(i){const e=JSON.parse(i);if(typeof e.xp=="number"&&e.upgrades)return e.selected||(e.selected="reguliere"),e.cleared||(e.cleared=[]),e.unlocked||(e.unlocked=[]),e.scores||(e.scores={}),e}}catch{}return{xp:0,upgrades:{},selected:"reguliere",cleared:[],unlocked:[],scores:{}}}function aa(i){localStorage.setItem(_h,JSON.stringify(i))}const Wt=i=>`<svg class="card-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round">${i}</svg>`,fx={blaster:Wt(`<circle cx="10" cy="24" r="4"/><path d="M18 24h10"/><path d="M32 24h4"/>
    ...
    <path d="M38 8 34 12l4 4" opacity="0.6"/><path d="M10 8l4 4-4 4" opacity="0.6"/>`)},dx="beat-survivor",oa="customTracks",vh=3;function px(){return new Promise((i,e)=>{const t=indexedDB.open(dx,1);t.onupgradeneeded=()=>{const n=t.result;n.objectStoreNames.contains(oa)||n.createObjectStore(oa,{keyPath:"id"})},t.onsuccess=()=>i(t.result),t.onerror=()=>e(t.error)})}function jo(i,e){return px().then(t=>new Promise((n,s)=>{const r=t.transaction(oa,i),a=e(r.objectStore(oa));a.onsuccess=()=>n(a.result),a.onerror=()=>s(a.error),r.oncomplete=()=>t.close()}))}async function xh(){try{return(await jo("readonly",e=>e.getAll())??[]).sort((e,t)=>t.addedAt-e.addedAt)}catch{return[]}}async function mx(i,e,t){try{const n={id:`${i.name}:${i.size}`,title:e,difficulty:t,addedAt:Date.now(),blob:i};await jo("readwrite",r=>r.put(n));const s=await xh();for(const r of s.slice(vh))await jo("readwrite",a=>a.delete(r.id))}catch{}}class gx{constructor(e,t){Q(this,"vesicles",[]);Q(this,"selected",0);Q(this,"root");Q(this,"svg");Q(this,"t",0);this.root=e,this.svg=t}setEntries(e){this.svg.innerHTML="",this.vesicles=e.map((t,n)=>{const s=document.createElementNS("http://www.w3.org/2000/svg","path");return this.svg.appendChild(s),t.dataset.filament=String(n),{el:t,angle:-Math.PI/2+n/e.length*Math.PI*2,radius:.42,phase:Math.random()*Math.PI*2}})}update(e,t,n){this.t+=e,this.selected=n;const s=this.vesicles.length;if(s===0)return;const r=this.svg.querySelectorAll("path");for(let a=0;a<s;a++){const o=this.vesicles[a],l=a===n;let u=-Math.PI/2+(a-n)/s*Math.PI*2+Math.PI-o.angle;for(;u>Math.PI;)u-=Math.PI*2;for(;u<-Math.PI;)u+=Math.PI*2;o.angle+=u*Math.min(1,e*6);const h=o.radius+(l?.035:0),f=50+Math.cos(o.angle)*h*100,d=50+Math.sin(o.angle)*h*100;o.el.style.left=`${f}%`,o.el.style.top=`${d}%`;const g=1+Math.sin(this.t*1.4+o.phase)*.012+t*(l?.07:.035);o.el.style.setProperty("--pulse",g.toFixed(3)),o.el.style.setProperty("--glow",(t*(l?1:.6)).toFixed(3));const _=r[a];if(_){const p=50+Math.cos(o.angle+.35)*h*46,m=50+Math.sin(o.angle+.35)*h*46;_.setAttribute("d",`M50 50 Q${p} ${m} ${f} ${d}`),_.classList.toggle("sel",l)}}}}const $t="./",re=i=>document.getElementById(i),_x=re("scene"),Mh=re("title"),Sh=re("hud"),yh=re("levelup"),Ma=re("end"),Al=re("pause"),Eh=re("options"),Th=re("custom"),bh=re("pharmacie"),Qo=re("intro"),Ah=re("controles"),Ei=re("analyse-status"),el=re("cards"),vx=re("hp"),xx=re("score"),Mx=re("time"),Sx=re("gauge-fill"),yx=re("weapons"),Ji=re("damage-flash"),Mt=new Set;addEventListener("keydown",i=>Mt.add(i.code));addEventListener("keyup",i=>Mt.delete(i.code));addEventListener("keydown",i=>{const e=i.code.match(/^(?:Digit|Numpad)([1-2])$/);if(e){const t=Number(e[1])-1;En=!1,ks=Ex(t),la=ks+1,Rh(!0),Cn(`DA : ${Uv[t]} (rotation auto coupée — R pour reprendre)`)}i.code==="KeyF"&&(En=!1,ks++,gs(0)),i.code==="KeyG"&&(En=!1,la++,gs(1)),i.code==="KeyR"&&(En=!En,Cn(`Rotation auto des textures : ${En?"ON":"OFF"}`)),i.code==="KeyV"&&Cn(`Couches textures : ${Qe.toggleLayers()?"ON":"OFF"}`),i.code==="KeyB"&&(We.spritesEnabled=!We.spritesEnabled,Cn(`Sprites du bestiaire : ${We.spritesEnabled?"ON":"OFF (vectoriel)"} — nouveaux spawns`))});const wh=["plasma","tissu"];let iu=null,bn=[];const Ch=new cv,su=new Map;let ks=0,la=1,En=!0,co=40,uo=65;function Ex(i){const e=wh[i],t=bn.findIndex(n=>n.piste===e);return t<0?0:t}function gs(i,e=!1){if(bn.length===0){Qe.setLayerTexture(i,null);return}const n=bn[((i===0?ks:la)%bn.length+bn.length)%bn.length],s=`${$t}textures/${n.piste}/${n.file}`;let r=su.get(s);r||(r=Ch.load(s),r.wrapS=r.wrapT=jr,r.colorSpace=Yt,su.set(s,r)),Qe.crossfadeLayer(i,r),i===0&&Qe.setStyle(n.piste==="plasma"?0:1),e||Cn(`Couche ${i===0?"proche":"lointaine"} : ${n.file.replace(".webp","")}`)}function Rh(i=!1){gs(0,i),gs(1,i)}function Tx(i){!En||bn.length===0||(co-=i,uo-=i,co<=0&&(co=40,ks+=1+Math.floor(Math.random()*3),gs(0,!0)),uo<=0&&(uo=65,la+=1+Math.floor(Math.random()*3),gs(1,!0)))}fetch(`${$t}textures/manifest.json`).then(i=>i.ok?i.json():null).then(i=>{iu=i,bn=[];for(const e of wh)for(const t of iu?.[e]??[])bn.push({piste:e,file:t});Rh(!0)}).catch(()=>{});const ca=new Fn(2,2);let Ps=null,Vr=null;function Dr(i){const e=Ch.load(i);return e.colorSpace=Yt,e}fetch(`${$t}sprites/manifest.json`).then(i=>i.ok?i.json():null).then(i=>{if(!i)return;const e={globule:{additive:!1,scale:1.6,rot:0},meduse:{additive:!1,scale:1.9,rot:-.09},dard:{additive:!0,scale:3.1,rot:-.27},kyste:{additive:!1,scale:1.7,rot:0},moucheron:{additive:!0,scale:2.5,rot:-Math.PI/2},colosse:{additive:!1,scale:1.5,rot:0}};for(const t of Object.keys(e)){const n=i[t];!n||n.length===0||We.setSprites(t,{textures:n.map(s=>Dr(`${$t}sprites/${t}/${s}`)),additive:e[t].additive,scale:e[t].scale,rotOffset:e[t].rot})}if(i.joueur){const t=i.joueur.find(s=>s.includes("membrane")),n=i.joueur.find(s=>s.includes("mito"));t&&n&&Me.setSprites(Dr(`${$t}sprites/joueur/${t}`),Dr(`${$t}sprites/joueur/${n}`))}if(i.pickups){const t=i.pickups.find(r=>r.includes("coeur")),n=i.pickups.find(r=>r.includes("prot")),s=r=>new it({map:Dr(`${$t}sprites/pickups/${r}`),transparent:!0,depthWrite:!1,blending:Un});t&&(Ps=s(t)),n&&(Vr=s(n))}}).catch(()=>{});let ru;function Cn(i){const e=re("toast");e.textContent=i,e.classList.remove("hidden"),clearTimeout(ru),ru=setTimeout(()=>e.classList.add("hidden"),1600)}function wl(){for(const i of navigator.getGamepads())if(i&&i.connected)return i;return null}let au=!1,ou=!1,lu=!1,cu=!1,uu=!1,Sa=!1,Ls=!1,Ds=!1,Cl=!1,Ph=!1;function bx(){const i=wl(),e=(i?.buttons[0]?.pressed??!1)||Mt.has("Enter")||Mt.has("Space"),t=(i?.buttons[1]?.pressed??!1)||Mt.has("Backspace"),n=(i?.buttons[9]?.pressed??!1)||Mt.has("Escape"),s=(i?.buttons[5]?.pressed??!1)||Mt.has("ShiftLeft")||Mt.has("ShiftRight"),r=i?.buttons[6],a=(r?r.pressed||r.value>.5:!1)||Mt.has("KeyE");Sa=e&&!au,au=e,Ls=t&&!ou,ou=t,Ds=n&&!lu,lu=n,Cl=s&&!cu,cu=s,Ph=a&&!uu,uu=a}function Rl(){const i=wl();if(i){const t=i.axes[0]??0,n=-(i.axes[1]??0),s=new X(t,n);if(s.length()>.15)return s}const e=new X(0,0);return(Mt.has("ArrowLeft")||Mt.has("KeyA")||Mt.has("KeyQ"))&&(e.x-=1),(Mt.has("ArrowRight")||Mt.has("KeyD"))&&(e.x+=1),(Mt.has("ArrowUp")||Mt.has("KeyW")||Mt.has("KeyZ"))&&(e.y+=1),(Mt.has("ArrowDown")||Mt.has("KeyS"))&&(e.y-=1),e.normalize()}function qn(i,e,t){wl()?.vibrationActuator?.playEffect?.("dual-rumble",{duration:t,strongMagnitude:i,weakMagnitude:e})}const ke=new AudioContext;let $n=null,It=null,tl=0;function Lh(){return ke.currentTime-tl}const Qe=new Ov(_x),Me=new Xv(Qe.scene),We=new tx(Qe.scene),at=new rx(Qe.scene),Hr=[],Ax=new ti(.8,1,20),ns=[],wx=new rn(1.1,16),Cx=new it({color:16743080,transparent:!0});function Rx(i){const e=Ps?new Be(ca,Ps.clone()):new Be(wx,Cx),t=Ps?2.8:1,n=new Be(ca,xa(16743080,.8));n.scale.setScalar(Ps?.95:2.2),n.position.z=-.05,e.add(n),e.scale.setScalar(t),e.position.set(i.x,i.y,1.2),Qe.scene.add(e),ns.push({pos:i.clone(),mesh:e,life:14,base:t})}function Px(){for(const i of ns)Qe.scene.remove(i.mesh);ns.length=0}const Rn=[],Lx=new rn(.5,8),Dx=new it({color:13631354,transparent:!0}),Ux=350,ho=new Set;let hu=!1,ua=Number(localStorage.getItem("bs-sfx")??"0.8");const ys=ke.createGain();ys.gain.value=ua;ys.connect(ke.destination);function Ix(){Kn(Me.pos,8255999);try{const i=ke.currentTime,e=ke.createOscillator(),t=ke.createGain();e.type="sine",e.frequency.setValueAtTime(620,i),e.frequency.exponentialRampToValueAtTime(980,i+.06),t.gain.setValueAtTime(.001,i),t.gain.exponentialRampToValueAtTime(.13,i+.015),t.gain.exponentialRampToValueAtTime(.001,i+.1),e.connect(t),t.connect(ys),e.start(i),e.stop(i+.12)}catch{}}function fu(){try{const i=ke.currentTime;for(const[e,t,n,s]of[[220,55,.5,.26],[146,41,.32,.3]]){const r=ke.createOscillator(),a=ke.createGain();r.type="square",r.frequency.setValueAtTime(e,i),r.frequency.exponentialRampToValueAtTime(t,i+s),a.gain.setValueAtTime(n,i),a.gain.exponentialRampToValueAtTime(.001,i+s),r.connect(a),a.connect(ys),r.start(i),r.stop(i+s+.02)}It&&(It.gain.cancelScheduledValues(i),It.gain.setValueAtTime(Dn,i),It.gain.linearRampToValueAtTime(Dn*.25,i+.04),It.gain.linearRampToValueAtTime(Dn,i+.5))}catch{}}const Gr=[],Nx=new ti(.85,1,24,1,Math.PI/4,Math.PI*1.5);let fo=0;function du(i,e,t){const n=new Be(Nx,new it({color:10479871,transparent:!0,opacity:.28*e}));n.position.set(i.x,i.y,4),n.rotation.z=t,Qe.scene.add(n),Gr.push({mesh:n,life:.7,scale:e})}function Fx(i,e){if(Rn.length>=Ux){Jn+=e,xi+=e;return}const t=Math.random()*Math.PI*2,n=Vr?new Be(ca,Vr):new Be(Lx,Dx);Vr&&n.scale.setScalar(.85),n.position.set(i.x,i.y,1.1),Qe.scene.add(n),Rn.push({pos:i.clone(),vel:new X(Math.cos(t),Math.sin(t)).multiplyScalar(5+Math.random()*9),value:e,mesh:n,homing:!1})}function Ox(){for(const i of Rn)Qe.scene.remove(i.mesh);Rn.length=0}const is=[];let nl=[],Wr=0;function Dh(){const i=new qi,e=[];for(let r=0;r<=60;r++){const a=r/60,o=a*Math.PI*6,l=.12+a*1.3;e.push(new P(Math.cos(o)*l,Math.sin(o)*l,0))}const t=new nh(new zt().setFromPoints(e),new Sl({color:10483199}));i.add(t);const n=new Be(ca,xa(10483199,.7));n.scale.setScalar(.5),n.position.z=-.05,i.add(n);const s=new X((Math.random()*2-1)*rt.hw*.75,(Math.random()*2-1)*rt.hh*.75);i.position.set(s.x,s.y,1.2),Qe.scene.add(i),is.push({pos:s,mesh:i})}function Bx(){for(const i of is)Qe.scene.remove(i.mesh);is.length=0}function Kn(i,e){const t=new Be(Ax,new it({color:e,transparent:!0,opacity:.9}));t.position.set(i.x,i.y,1.8),Qe.scene.add(t),Hr.push({mesh:t,life:.45})}let lt="title",Oe=null,il=null,pn=!1,Ks="";const qe=hx(),Nt=i=>qe.upgrades[i]??0,Uh=i=>{const e=ms.find(t=>t.id===i);return e?e.unlockFile?(qe.unlocked??[]).includes(i)||Nt(i)>0:!0:!1};function zx(i){if(!i.unlockFile)return"";const e=Ta.find(n=>n.file===i.unlockFile)?.title??i.unlockFile.replace(/\.[^.]+$/,""),t=ms.find(n=>n.id===i.unlockWith);return t&&t.id!=="reguliere"?`Réussis « ${e} » avec ${t.name}`:`Réussis « ${e} » avec la Régulière`}const kx=()=>ms.find(i=>i.id===(qe.selected??"reguliere"))??ms[0];let Xr=1,Ih=!1,Nh=!1,ha=1,xi=0,Fh="reguliere";const Pl=15,Vx=.8;let ss=0,Jn=0,Zs=Pl,fa=0,jn=[],Us=0,sl=0,cn={bass:0,mid:0,high:0},qr=0,rl={high:0,mid:0};function st(i,e){i.classList.toggle("hidden",!e)}async function Oh(i,e=!0){if(!pn){pn=!0,_i=null,Ei.textContent=`Décodage de « ${i.name} »…`;try{const t=await ke.decodeAudioData(await i.arrayBuffer());Ks=i.name.replace(/\.[^.]+$/,""),os=`custom:${i.name}:${i.size}`,await Ll(t),e&&Oe&&await mx(i,Ks,dv(Oe))}catch(t){Ei.textContent="Impossible de décoder ce fichier — un autre format ?",pn=!1,console.error(t)}}}async function Bh(){if(pn)return;pn=!0,_i=null,os=null,Ei.textContent="Synthèse de la piste démo…",Ks="Piste démo";const i=await gv();await Ll(i)}async function Ll(i){Ei.textContent="Analyse du morceau (onsets, énergie)…",await new Promise(e=>setTimeout(e,30)),Oe=await uh(i),il=i,Ei.textContent="",pn=!1,zh(i)}function zh(i){Me.reset(),We.clear(),at.reset(),Me.hp=3+Nt("vacuole"),Xr=1+.04*Nt("cils"),at.metaDamageMul=1+.08*Nt("concentres"),at.metaMagnet=2.5*Nt("phago"),at.bonusNukes=Nt("reserve"),We.kysteRadiusMul=1+.18*Nt("virulence"),Js=Nt("reroll"),at.saccadeLevel=Nt("saccade"),xi=0;const e=Uh(qe.selected??"reguliere")?qe.selected??"reguliere":"reguliere";Fh=e,Ih=e==="symbiote",Nh=e==="tardigrade",ha=1,e==="phage"&&(Me.hp=1+Nt("vacuole"),at.metaDamageMul*=1.5,Xr*=1.1),e==="amibe"&&(Me.hp=Math.max(1,Me.hp-1),at.metaMagnet+=8,ha=1.5,Xr*=.92),Qx(.4);const t=Oe?.duration??60;nl=Array.from({length:2+Math.floor(Math.random()*3)},()=>t*(.3+Math.random()*.62)).sort((n,s)=>n-s),Wr=0,ss=0,Jn=0,fa=0,Zs=Pl,cn={bass:0,mid:0,high:0},qr=0,rl={high:0,mid:0},sl=0,Px(),Ox(),Bx(),$n?.stop(),$n=ke.createBufferSource(),$n.buffer=i,It=ke.createGain(),It.gain.value=Dn,$n.connect(It),It.connect(ke.destination),ke.resume(),tl=ke.currentTime+.1,$n.start(tl),lt="run",st(Mh,!1),st(re("survie"),!1),st(re("perso"),!1),st(Th,!1),st(bh,!1),st(Ah,!1),st(Ma,!1),st(Sh,!0),oM(),ya()}function Hx(i){if(!It||!$n)return;const e=ke.currentTime;It.gain.setValueAtTime(It.gain.value,e),It.gain.linearRampToValueAtTime(0,e+i);const t=$n;$n=null,setTimeout(()=>{try{t.stop()}catch{}},i*1e3+200)}function da(i,e=!1){if(lt="end",ke.resume(),st(Al,!1),Hx(i?2.5:1),qe.xp+=xi,i&&_i){qe.cleared=qe.cleared??[],qe.unlocked=qe.unlocked??[],qe.cleared.includes(_i)||qe.cleared.push(_i);const n=ms.find(s=>s.unlockFile===_i);n&&!qe.unlocked.includes(n.id)&&(n.unlockWith??"reguliere")===Fh&&(qe.unlocked.push(n.id),Cn(`Personnage débloqué : ${n.name} !`))}aa(qe),re("end-title").textContent=e?"RUN INTERROMPUE":i?"Victoire !":"Tu es contaminé";let t="";if(os){qe.scores=qe.scores??{};const n=qe.scores[os]??0;go=ss>n,go&&(qe.scores[os]=ss,aa(qe)),t=go?'<span class="record">NOUVEAU RECORD</span>':n>0?`<span class="dim">record : ${n}</span>`:""}re("end-stats").innerHTML=`<span class="end-score">${ss}</span> points ${t}<br />${Ks} — ${kx().name} · ${Yh(Lh())} · niveau ${fa+1} · +${Math.round(xi)} XP (banque : ${qe.xp})`,st(Ma,!0),On([re("btn-replay"),re("btn-restart")],"x")}function Gx(){if(lt!=="run")return;lt="victory";const i=[...We.list];let e=0;const t=()=>{for(let n=0;n<3&&e<i.length;n++,e++){const s=i[e],r=We.list.indexOf(s);r>=0&&(Kn(s.pos,Ki[s.kind].color),We.remove(r))}e<i.length?setTimeout(t,55):setTimeout(()=>da(!0),700)};Qe.kick(1.6),qn(.5,.8,400),t()}function Wx(){lt="pause",ke.suspend(),st(Al,!0),On([re("btn-resume"),re("btn-abort")],"y")}function kh(){st(Al,!1),ke.resume(),lt="run"}let rs=[],as=0,Ur=0,Vh="x",Yr=0;function On(i,e="x",t=0){rs.forEach(n=>n.classList.remove("sel")),rs=i,Vh=e,Yr=t,as=0,Hh()}function Hh(){rs.forEach((i,e)=>i.classList.toggle("sel",e===as))}function po(i){if(rs.length===0)return;Ur=Math.max(0,Ur-i);const e=Rl();let t=0;if(Yr>0)Math.abs(e.x)>.5?t=Math.sign(e.x):Math.abs(e.y)>.5&&(t=e.y>0?-Yr:Yr);else{const n=Vh==="x"?e.x:-e.y;Math.abs(n)>.5&&(t=Math.sign(n))}Ur<=0&&t!==0&&(as=fs.euclideanModulo(as+t,rs.length),Ur=.25,Hh()),Sa&&rs[as].click()}function Xx(){if(jn=at.drawCards(),jn.length!==0){if(Ih){const i=jn[Math.floor(Math.random()*jn.length)];at.pick(i.kind),ya(),Cn(`Symbiote : ${Zi[i.kind].name}`);return}lt="levelup",ke.suspend(),Gh(),Wh(),st(yh,!0)}}function Gh(){Us=0,el.innerHTML="",jn.forEach((i,e)=>{const t=Zi[i.kind],n=ph(i.kind),s=at.levels.get(i.kind)??0;let r="";for(let o=1;o<=n;o++)r+=`<span class="pip${o<=s?" filled":o===i.level?" next":""}"></span>`;const a=document.createElement("div");a.className="card"+(e===0?" sel":""),a.dataset.cat=t.cat,a.innerHTML=`<span class="cat">${t.cat}</span>${fx[i.kind]}<h3>${t.name}</h3><p>${t.desc}</p><div class="pips">${r}<span class="pipnum">${i.level}/${n}</span></div>`,a.addEventListener("click",()=>qh(e)),el.appendChild(a)})}let Js=0;function Wh(){const i=re("btn-reroll");i.classList.toggle("hidden",Nt("reroll")===0),i.textContent=`Relancer (R1) · ×${Js}`,i.disabled=Js<=0}function Xh(){lt!=="levelup"||Js<=0||(Js--,jn=at.drawCards(),Gh(),Wh())}function qh(i){at.pick(jn[i].kind),ya(),st(yh,!1),ke.resume(),lt="run"}let Ir=0,mo=0;function qx(i){Ir=Math.max(0,Ir-i);const e=Rl();Ir<=0&&Math.abs(e.x)>.5&&(Us=fs.euclideanModulo(Us+Math.sign(e.x),jn.length),Ir=.25,[...el.children].forEach((t,n)=>t.classList.toggle("sel",n===Us))),Cl&&Xh(),Sa&&qh(Us)}let al=!1;function Yx(i,e){if(!Oe)return null;const t=Oe.bass.onsets.find(n=>n.t>=i&&n.t<=e);return t?t.t:null}function $x(i){if(!Oe)return;const e=1+i/60*.4,t=$i(Oe.intensity,Oe.fps,i),n=.75+t*.5,s=Math.min(1,i/(Oe.duration||60)),r=.35+.8*Math.pow(s,.8),a=Vx*r;for(;Wr<nl.length&&nl[Wr]<=i;)Wr++,Dh();for(;qr<Oe.drops.length&&Oe.drops[qr]<=i;){qr++,Qe.kick(1.4);const o=Math.max(3,Math.round(8*r));for(let l=0;l<o;l++)We.spawn("dard",Me.pos,.8,e,n);We.spawn("globule",Me.pos,1,e,n),r>.6&&We.spawn("globule",Me.pos,.8,e,n)}for(;cn.bass<Oe.bass.onsets.length&&Oe.bass.onsets[cn.bass].t<=i;){const o=Oe.bass.onsets[cn.bass++];if(al=!0,!(t<.12)&&!(Math.random()>a)){if(s>.6&&Math.random()<.16){We.spawn("colosse",Me.pos,o.s,e,n);const l=We.list[We.list.length-1];l&&l.kind==="colosse"&&(l.deadline=Yx(i+11,i+14)??i+12)}else We.spawn("globule",Me.pos,o.s,e,n);o.s>.75&&Qe.kick(o.s),t>.7&&o.s>.7&&r>.7&&We.spawn("globule",Me.pos,o.s*.7,e,n)}}for(;cn.mid<Oe.mid.onsets.length&&Oe.mid.onsets[cn.mid].t<=i;){const o=Oe.mid.onsets[cn.mid++];++rl.mid%3===0&&t>.25&&Math.random()<=a&&(s>.25&&Math.random()<.35?We.spawn("kyste",Me.pos,o.s,e,n):We.spawn("meduse",Me.pos,o.s,e,n))}for(;cn.high<Oe.high.onsets.length&&Oe.high.onsets[cn.high].t<=i;){const o=Oe.high.onsets[cn.high++];++rl.high%2===0&&t>.4&&Math.random()<=a&&(s>.45&&Math.random()<.35?We.squad("moucheron",Me.pos,3,o.s,e,n):We.spawn("dard",Me.pos,o.s,e,n))}}function ya(){yx.innerHTML=at.describe().map(i=>`<div>${i}</div>`).join("")}function Yh(i){const e=Math.max(0,i),t=Math.floor(e/60),n=Math.floor(e%60);return`${t}:${n.toString().padStart(2,"0")}`}function $r(i){const e=Ki[i.kind];if(ss+=e.score,Kn(i.pos,e.color),i.kind==="colosse")We.emitRadial("dard",i.pos,6,1.05);else{const n=i.kind==="globule"?2:1,s=Math.floor(e.xp/n);let r=e.xp-s*n;for(let a=0;a<n;a++)Fx(i.pos,s+(r-- >0?1:0))}const t=at.mitoseThreshold;t>0&&++sl>=t&&(sl=0,Rx(i.pos))}function Kx(){Jn>=Zs&&(Jn=0,fa+=1,Zs=Math.round(Pl*Math.pow(1.4,fa)),Xx())}function Zx(){Qe.kick(2),qn(1,1,500),Ji.classList.add("on","nuke"),setTimeout(()=>Ji.classList.remove("on","nuke"),220);for(let i=We.list.length-1;i>=0;i--){const e=We.list[i];e.hp=0,$r(e),We.remove(i)}}let pu=performance.now(),$h=0;function Kh(i){$h=i;const e=Math.min(.05,(i-pu)/1e3);if(pu=i,bx(),lt==="levelup"){if(Ds){da(!1,!0);return}qx(e);return}if(lt==="pause"){if(Ds||Ls){kh();return}po(e);return}const t=lt==="run"?Lh():0,n=lt!=="run",s=!n&&Oe?$i(Oe.bass.env,Oe.fps,t):.12+.12*Math.sin(i/1e3*2.1),r=!n&&Oe?$i(Oe.energy,Oe.fps,t):.2,a=!n&&Oe?$i(Oe.intensity,Oe.fps,t):.15,o=!n&&Oe?$i(Oe.mid.env,Oe.fps,t):.45;if(Dl?(lt==="title"&&_s==="home"&&!Vs&&tf.update(e,jx(),as),lt==="title"&&!pn&&!Vs&&(Ea?Ls&&re("btn-options-close").click():Ls&&_s!=="home"?nf():po(e)),lt==="end"&&po(e)):(Sa||Ds||Ls)&&Ul(),lt==="run"){if(Ds){Wx();return}if(Me.speedBonus=at.speedBonus*Xr,Me.beat=s,Cl&&Me.tryDash(at.dashCooldown)&&(Kn(Me.pos,11533311),du(Me.pos,1.8,Math.atan2(Me.lastDir.y,Me.lastDir.x)),qn(.25,.5,90),ho.clear()),fo-=e,fo<=0&&Me.vel.length()>16&&(fo=.14,du(Me.pos,.9,Math.atan2(Me.vel.y,Me.vel.x))),Tx(e),Me.update(e,Rl()),Me.dashing){at.dashInvuln&&(Me.invuln=Math.max(Me.invuln,.06));const c=at.dashDamage;if(c>0)for(let u=We.list.length-1;u>=0;u--){const h=We.list[u];ho.has(h)||h.pos.distanceTo(Me.pos)<h.radius+2.4&&(ho.add(h),h.hp-=c,h.hp<=0&&($r(h),We.remove(u)))}}Ph&&at.fireNuke()&&Zx(),al=!1,$x(t),at.beatNow=al,We.update(e,t,Me.pos,{onKill:c=>$r(c),onPop:(c,u)=>{Kn(c,u==="kyste"?16752720:13641816),Qe.kick(u==="colosse"?1:.7),qn(.3,.4,140)}}),at.update(e,Me,We,c=>$r(c.enemy)),hu&&Me.dashCd<=0&&Ix(),hu=Me.dashCd>0;for(let c=is.length-1;c>=0;c--){const u=is[c];if(u.mesh.rotation.z-=e*2.8,u.pos.distanceTo(Me.pos)<3){for(const h of Rn)h.homing=!0;Kn(u.pos,10483199),qn(.3,.6,200),Cn("Aspiration !"),Qe.scene.remove(u.mesh),is.splice(c,1)}}const l=at.magnetRadius;for(let c=Rn.length-1;c>=0;c--){const u=Rn[c],h=u.pos.distanceTo(Me.pos);if(u.homing){const f=new X().subVectors(Me.pos,u.pos).normalize();u.vel.addScaledVector(f,e*500),u.vel.length()>95&&u.vel.setLength(95)}else if(u.vel.multiplyScalar(Math.max(0,1-e*3)),h<l){const f=new X().subVectors(Me.pos,u.pos).normalize();u.vel.addScaledVector(f,e*160)}u.pos.addScaledVector(u.vel,e),u.mesh.position.set(u.pos.x,u.pos.y,1.1),h<2.2&&(Jn+=u.value*ha,xi+=Math.round(u.value*ha),Qe.scene.remove(u.mesh),Rn.splice(c,1))}Kx();for(let c=ns.length-1;c>=0;c--){const u=ns[c];u.life-=e,u.mesh.scale.setScalar(u.base*(1+Math.sin(t*5)*.15)),u.mesh.material.opacity=Math.min(1,u.life/2),u.pos.distanceTo(Me.pos)<3&&(Me.heal(),Kn(u.pos,16743080),u.life=0),u.life<=0&&(Qe.scene.remove(u.mesh),ns.splice(c,1))}for(const c of We.list)c.pos.distanceTo(Me.pos)<c.radius+1.6&&(Me.invuln<=0&&at.absorbHit()?(Me.invuln=1.2,Kn(Me.pos,8255999),qn(.4,.3,120)):Nh?Me.invuln<=0&&(Me.invuln=1.2,Jn=Math.max(0,Jn-Zs*.5),xi=Math.max(0,xi-12),qn(.6,.5,200),fu(),Ji.classList.add("on"),setTimeout(()=>Ji.classList.remove("on"),120)):Me.hit()&&(qn(.9,.6,220),fu(),Ji.classList.add("on"),setTimeout(()=>Ji.classList.remove("on"),120),Me.hp<=0&&da(!1)));Oe&&t>=Oe.duration-.05&&Gx(),vx.textContent="♥".repeat(Math.max(0,Me.hp)),xx.textContent=String(ss),Mx.textContent=Yh((Oe?.duration??0)-t),Sx.style.width=`${Math.min(100,Jn/Zs*100)}%`,mo-=e,mo<=0&&(ya(),mo=.3)}for(let l=Gr.length-1;l>=0;l--){const c=Gr[l];c.life-=e;const u=1-c.life/.7;c.mesh.scale.setScalar((1.2+u*4.5)*c.scale),c.mesh.material.opacity=.28*c.scale*(1-u),c.life<=0&&(Qe.scene.remove(c.mesh),c.mesh.material.dispose(),Gr.splice(l,1))}for(let l=Hr.length-1;l>=0;l--){const c=Hr[l];c.life-=e;const u=1-c.life/.45;c.mesh.scale.setScalar(1+u*6),c.mesh.material.opacity=.9*(1-u),c.life<=0&&(Qe.scene.remove(c.mesh),c.mesh.material.dispose(),Hr.splice(l,1))}Qe.update(e,i/1e3,{bass:s,energy:r,intensity:lt==="run"?a:.12,mid:o,danger:lt==="run"?Math.min(1,We.list.length/70):0},Me.pos)}function Zh(i){Kh(i),requestAnimationFrame(Zh)}requestAnimationFrame(Zh);new URLSearchParams(location.search).has("autotick")&&setInterval(()=>{const i=performance.now();i-$h>100&&Kh(i)},33);let Ea=!1,Dn=Number(localStorage.getItem("bs-volume")??"1"),Is=null,ol=null,en=null,fn=null;function Jh(i,e){const t=ke.createBufferSource();t.buffer=i;const n=ke.createGain();n.gain.value=e,t.connect(n),n.connect(ys),t.start()}let ji=null,jh=0;async function Jx(i){if(!ji)try{ji=await uh(i)}catch{}}async function Qh(){en||(Is||(Is=await mh()),!en&&(en=ke.createBufferSource(),en.buffer=Is,en.loop=!0,fn=ke.createGain(),fn.gain.setValueAtTime(1e-4,ke.currentTime),fn.gain.linearRampToValueAtTime(.35*Dn,ke.currentTime+2.8),en.connect(fn),fn.connect(ke.destination),en.start(),jh=ke.currentTime,Jx(Is)))}function jx(){if(!ji||!en)return 0;const i=(ke.currentTime-jh)%ji.duration;return $i(ji.bass.env,ji.fps,i)}function Qx(i){if(!en||!fn)return;const e=en,t=fn;en=null,fn=null;const n=ke.currentTime;t.gain.setValueAtTime(t.gain.value,n),t.gain.linearRampToValueAtTime(0,n+i),setTimeout(()=>{try{e.stop()}catch{}},i*1e3+100)}let Dl=!1,Qi="wait";function Ul(){Qi==="wait"?(Qi="logo",ke.resume(),ax().then(i=>Jh(i,.55)),ox().then(i=>ol=i),mh().then(i=>Is=i),re("intro-prompt").classList.add("hidden"),re("intro-logo").classList.add("on"),setTimeout(()=>{Qi==="logo"&&mu()},4300)):Qi==="logo"&&mu()}function mu(){Qi!=="done"&&(Qi="done",Qo.classList.add("fadeout"),setTimeout(()=>{Qo.classList.add("hidden"),Dl=!0,lx(),ol&&Jh(ol,.6),Qh(),Il()},950))}Qo.addEventListener("click",Ul);addEventListener("keydown",()=>{Dl||Ul()});let _s="home",Mi=null;const eM={easy:"EASY",normal:"NORMAL",hard:"HARD"};let Ta=[];fetch(`${$t}music/manifest.json`).then(i=>i.ok?i.json():null).then(i=>{i?.tracks&&(Ta=i.tracks)}).catch(()=>{});let _i=null,os=null,go=!1;async function tM(i){if(!pn){pn=!0,gu(`Chargement de « ${i.title} »…`);try{const e=await fetch(`${$t}music/${encodeURIComponent(i.file)}`),t=await ke.decodeAudioData(await e.arrayBuffer());Ks=i.title,_i=i.file,os=i.file,await Ll(t)}catch(e){gu("Impossible de charger ce morceau."),pn=!1,console.error(e)}}}function gu(i){Ei.textContent=i}function nM(){const i=re("track-list");i.innerHTML="";const e=[];for(const t of Ta){const n=document.createElement("button"),s=(qe.cleared??[]).includes(t.file),r=t.difficulty??"normal";n.classList.add("track-btn");const a=qe.scores?.[t.file]??0;n.innerHTML=ef(t.title,r,`${a>0?a+" ":""}${s?"✓":""}`),n.addEventListener("click",()=>{ke.resume(),Mi={type:"track",track:t},Bt("perso")}),i.appendChild(n),e.push(n)}e.push(re("btn-survie-back")),On(e,"y")}function ef(i,e,t){const n={easy:[5,7],normal:[9,4.5],hard:[15,2.4]},[s,r]=n[e]??n.normal;let a="";for(let o=0;o<s;o++){const l=2.2+o*37%5*.5,c=3+o*53%46,u=3+o*29%19,h=(o*17%9-4).toFixed(1),f=(o*23%7-3).toFixed(1);a+=`<i style="left:${c}px;top:${u}px;width:${l}px;height:${l}px;--sp:${(r+o*13%10*.25).toFixed(2)}s;--dx:${h}px;--dy:${f}px;animation-delay:-${o*31%40/10}s"></i>`}return`<span class="tk-diff" data-diff="${e}"><span class="colony">${a}</span><span class="tk-lab">${eM[e]}</span></span><span class="tk-title">${i}</span><span class="tk-done">${t}</span>`}function iM(){const i=re("custom-list");i.innerHTML="",On([re("btn-custom-back")],"y"),xh().then(e=>{if(_s!=="custom")return;i.innerHTML="";const t=[];if(e.length>0){const n=document.createElement("p");n.className="dim",n.textContent=`Tes ${vh} derniers morceaux :`,i.appendChild(n)}for(const n of e){const s=document.createElement("button");s.className="secondary track-btn";const r=qe.scores?.[`custom:${n.id}`]??0;s.innerHTML=ef(n.title,n.difficulty,r>0?`${r}`:""),s.addEventListener("click",()=>{ke.resume(),sM(n)}),i.appendChild(s),t.push(s)}t.push(re("btn-custom-back")),On(t,"y")})}function sM(i){const e=new File([i.blob],i.id.split(":")[0],{type:i.blob.type});Oh(e,!1)}function rM(){const i=re("perso-list");i.innerHTML="";const e=[];for(const t of ms){const n=Uh(t.id),s=(qe.selected??"reguliere")===t.id,r=document.createElement("button");r.className="pharma-card"+(s&&n?" active":""),r.disabled=!n,r.innerHTML=`<span class="pc-name">${t.name}</span><span class="pc-desc">${t.desc}</span><span class="pc-cost${s&&n?" active-label":""}">${n?s?"Plonger (actif)":"Plonger":zx(t)}</span>`,n&&r.addEventListener("click",()=>{qe.selected=t.id,aa(qe),aM()}),i.appendChild(r),e.push(r)}e.push(re("btn-perso-back")),On(e,"y",5)}function aM(){const i=Mi;if(Mi=null,!i)return Bt("home");i.type==="track"?tM(i.track):i.type==="demo"?Bh():Bt("custom")}const tf=new gx(re("organism"),re("filaments"));function Il(){const i=[re("btn-survie"),re("btn-custom"),re("btn-pharmacie"),re("btn-controles"),re("btn-options")];On(i,"y"),tf.setEntries(i)}function oM(){const i=re("menu-bg");i.src&&(i.classList.remove("hidden"),i.classList.add("dive"),i.play().catch(()=>{}),setTimeout(()=>{i.classList.add("hidden"),i.classList.remove("dive"),i.pause()},750))}let Vs=!1;function nr(i,e){if(Vs)return;Vs=!0;const t=re("organism");t.classList.add("absorbing"),i.classList.add("absorb"),setTimeout(()=>{t.classList.remove("absorbing"),i.classList.remove("absorb"),Vs=!1,e()},480)}fetch(`${$t}video/manifest.json`).then(i=>i.ok?i.json():null).then(i=>{const e=i?.clips??[];if(e.length===0)return;const t=re("specimen");t.src=`${$t}video/${e[0]}`,t.play().catch(()=>{});const n=re("menu-bg");n.src=`${$t}video/${e[1]??e[0]}`}).catch(()=>{});function Bt(i){_s=i;const e=re("menu-bg"),t=i!=="home";e.classList.toggle("hidden",!t),t?e.play().catch(()=>{}):e.pause(),st(Mh,i==="home"),st(re("survie"),i==="survie"),st(re("perso"),i==="perso"),st(Th,i==="custom"),st(bh,i==="pharmacie"),st(Ah,i==="controles"),i==="home"&&Il(),i==="survie"&&nM(),i==="perso"&&rM(),i==="custom"&&iM(),i==="pharmacie"&&sf(),i==="controles"&&On([re("btn-controles-back")],"y")}function nf(){if(_s==="perso"){const i=Mi?.type==="track"||Mi?.type==="demo";Mi=null,Bt(i?"survie":"home")}else _s!=="home"&&Bt("home")}function sf(){re("pharma-xp").textContent=`${qe.xp} XP en banque`;const i=re("pharma-list");i.innerHTML="";const e=[];for(const t of cx){const n=Nt(t.id),s=ux(t,n),r=n>=t.max,a=document.createElement("button");a.className="pharma-card",a.disabled=r||qe.xp<s,a.innerHTML=`<span class="pc-name">${t.name}</span><span class="pc-desc">${t.desc}</span><span class="pc-lvl">${"●".repeat(n)}${"○".repeat(t.max-n)}</span><span class="pc-cost">${r?"MAX":`${s} XP`}</span>`,r||a.addEventListener("click",()=>{qe.xp>=s&&Nt(t.id)<t.max&&(qe.xp-=s,qe.upgrades[t.id]=Nt(t.id)+1,aa(qe),Cn(`Pharmacie : ${t.name} amélioré`),sf())}),i.appendChild(a),e.push(a)}e.push(re("btn-pharma-back")),On(e,"y",4)}re("btn-survie").addEventListener("click",i=>{ke.resume(),nr(i.currentTarget,()=>{Ta.length>0?Bt("survie"):Bh()})});re("btn-survie-back").addEventListener("click",()=>Bt("home"));re("btn-custom").addEventListener("click",i=>{nr(i.currentTarget,()=>{Mi={type:"custom"},Bt("perso")})});re("btn-perso-back").addEventListener("click",nf);re("btn-pharmacie").addEventListener("click",i=>nr(i.currentTarget,()=>Bt("pharmacie")));re("btn-controles").addEventListener("click",i=>nr(i.currentTarget,()=>Bt("controles")));re("btn-custom-back").addEventListener("click",()=>Bt("home"));re("btn-pharma-back").addEventListener("click",()=>Bt("home"));re("btn-controles-back").addEventListener("click",()=>Bt("home"));re("btn-restart").addEventListener("click",()=>{st(Ma,!1),st(Sh,!1),Ei.textContent="",We.clear(),lt="title",Bt("home"),Qh()});re("btn-replay").addEventListener("click",()=>{il&&Oe&&(st(Ma,!1),zh(il))});re("btn-resume").addEventListener("click",kh);re("btn-abort").addEventListener("click",()=>da(!1,!0));re("btn-reroll").addEventListener("click",Xh);const Kr=re("opt-volume"),Zr=re("opt-sfx"),ll=re("opt-layers"),cl=re("opt-rotate");Kr.value=String(Dn);Zr.value=String(ua);Zr.addEventListener("input",()=>{ua=Number(Zr.value),localStorage.setItem("bs-sfx",Zr.value),ys.gain.value=ua});re("btn-options").addEventListener("click",i=>{nr(i.currentTarget,()=>{Ea=!0,ll.checked=Qe.layersEnabled,cl.checked=En,st(Eh,!0)})});re("btn-options-close").addEventListener("click",()=>{Ea=!1,st(Eh,!1),Il()});addEventListener("keydown",i=>{i.code==="Escape"&&Ea&&re("btn-options-close").click()});Kr.addEventListener("input",()=>{Dn=Number(Kr.value),localStorage.setItem("bs-volume",Kr.value),It&&lt==="run"&&(It.gain.value=Dn),fn&&(fn.gain.value=.35*Dn)});ll.addEventListener("change",()=>{ll.checked!==Qe.layersEnabled&&Qe.toggleLayers()});cl.addEventListener("change",()=>{En=cl.checked});const Nl=re("dropzone");addEventListener("dragover",i=>{i.preventDefault(),Nl.classList.add("drag")});addEventListener("dragleave",()=>Nl.classList.remove("drag"));addEventListener("drop",i=>{if(i.preventDefault(),Nl.classList.remove("drag"),lt!=="title")return;const e=i.dataTransfer?.files?.[0];e&&(ke.resume(),Oh(e))});window.__bs={get analysis(){return Oe},get phase(){return lt},get weapons(){return at},get ship(){return Me},get enemies(){return We},get proteins(){return Rn},spawnSpiral:Dh};
